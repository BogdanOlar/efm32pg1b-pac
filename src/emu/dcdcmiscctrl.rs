...
///Register `DCDCMISCCTRL` writer
pub type W = crate::W<DCDCMISCCTRLrs>;
///Field `LNFORCECCM` reader - Force DCDC Into CCM Mode in Low Noise Operation
pub type LnforceccmR = crate::BitReader;
///Field `LNFORCECCM` writer - Force DCDC Into CCM Mode in Low Noise Operation
pub type LnforceccmW<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PFETCNT` reader - PFET Switch Number Selection
pub type PfetcntR = crate::FieldReader;
///Field `PFETCNT` writer - PFET Switch Number Selection
pub type PfetcntW<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `NFETCNT` reader - NFET Switch Number Selection
pub type NfetcntR = crate::FieldReader;
///Field `NFETCNT` writer - NFET Switch Number Selection
pub type NfetcntW<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `BYPLIMSEL` reader - Current Limit in Bypass Mode
pub type ByplimselR = crate::FieldReader;
///Field `BYPLIMSEL` writer - Current Limit in Bypass Mode
pub type ByplimselW<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `LPCLIMILIMSEL` reader - Current Limit Level Selection for Current Limiter in LP Mode
pub type LpclimilimselR = crate::FieldReader;
///Field `LPCLIMILIMSEL` writer - Current Limit Level Selection for Current Limiter in LP Mode
pub type LpclimilimselW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `LNCLIMILIMSEL` reader - Current Limit Level Selection for Current Limiter in LN Mode
pub type LnclimilimselR = crate::FieldReader;
///Field `LNCLIMILIMSEL` writer - Current Limit Level Selection for Current Limiter in LN Mode
...
#[repr(u8)]
pub enum LPCMPBIAS {
    ///0: Maximum load current less than 75uA.
    Bias0 = 0,
    ///1: Maximum load current less than 500uA.
    Bias1 = 1,
    ///2: Maximum load current less than 2.5mA.
    Bias2 = 2,
    ///3: Maximum load current less than 10mA.
    Bias3 = 3,
}
...
///Field `LPCMPBIAS` reader - LP Mode Comparator Bias Selection
...
///Field `LPCMPBIAS` writer - LP Mode Comparator Bias Selection
...
///`read()` method returns [`dcdcmiscctrl::R`](R) reader structure
