///Register `RAM0CTRL` reader
pub type R = crate::R<RAM0CTRLrs>;
///Register `RAM0CTRL` writer
...
pub enum RAMPOWERDOWN {
    ...
    None = 0,
    ///8: Power down RAM blocks 4 and above
    Blk4 = 8,
    ///12: Power down RAM blocks 3 and above
    Blk3to4 = 12,
    ///14: Power down RAM blocks 2 and above
    Blk2to4 = 14,
    ///15: Power down RAM blocks 1 and above
    Blk1to4 = 15,
}
...
///Field `RAMPOWERDOWN` reader - RAM0 Blockset Power-down
...
///Field `RAMPOWERDOWN` writer - RAM0 Blockset Power-down
...
///`read()` method returns [`ram0ctrl::R`](R) reader structure
