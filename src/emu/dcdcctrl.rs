...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DCDCCTRL")
            .field("dcdcmode", &format_args!("{}", self.dcdcmode().bits()))
            .field(
                "dcdcmodeem23",
                &format_args!("{}", self.dcdcmodeem23().bit()),
            )
            .field("dcdcmodeem4", &format_args!("{}", self.dcdcmodeem4().bit()))
            .finish()
    }
}
impl core::fmt::Debug for crate::generic::Reg<DCDCCTRL_SPEC> {
