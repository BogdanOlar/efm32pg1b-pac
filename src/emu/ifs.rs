...
pub type VMONAVDDFALL_W<'a, const O: u8> = crate::BitWriter<'a, IFS_SPEC, O>;
#[doc = "Field `VMONAVDDRISE` writer - Set VMONAVDDRISE Interrupt Flag"]
pub type VMONAVDDRISE_W<'a, const O: u8> = crate::BitWriter<'a, IFS_SPEC, O>;
#[doc = "Field `VMONALTAVDDFALL` writer - Set VMONALTAVDDFALL Interrupt Flag"]
pub type VMONALTAVDDFALL_W<'a, const O: u8> = crate::BitWriter<'a, IFS_SPEC, O>;
#[doc = "Field `VMONALTAVDDRISE` writer - Set VMONALTAVDDRISE Interrupt Flag"]
pub type VMONALTAVDDRISE_W<'a, const O: u8> = crate::BitWriter<'a, IFS_SPEC, O>;
#[doc = "Field `VMONDVDDFALL` writer - Set VMONDVDDFALL Interrupt Flag"]
pub type VMONDVDDFALL_W<'a, const O: u8> = crate::BitWriter<'a, IFS_SPEC, O>;
#[doc = "Field `VMONDVDDRISE` writer - Set VMONDVDDRISE Interrupt Flag"]
pub type VMONDVDDRISE_W<'a, const O: u8> = crate::BitWriter<'a, IFS_SPEC, O>;
#[doc = "Field `VMONIO0FALL` writer - Set VMONIO0FALL Interrupt Flag"]
pub type VMONIO0FALL_W<'a, const O: u8> = crate::BitWriter<'a, IFS_SPEC, O>;
#[doc = "Field `VMONIO0RISE` writer - Set VMONIO0RISE Interrupt Flag"]
pub type VMONIO0RISE_W<'a, const O: u8> = crate::BitWriter<'a, IFS_SPEC, O>;
#[doc = "Field `VMONFVDDFALL` writer - Set VMONFVDDFALL Interrupt Flag"]
pub type VMONFVDDFALL_W<'a, const O: u8> = crate::BitWriter<'a, IFS_SPEC, O>;
#[doc = "Field `VMONFVDDRISE` writer - Set VMONFVDDRISE Interrupt Flag"]
pub type VMONFVDDRISE_W<'a, const O: u8> = crate::BitWriter<'a, IFS_SPEC, O>;
#[doc = "Field `PFETOVERCURRENTLIMIT` writer - Set PFETOVERCURRENTLIMIT Interrupt Flag"]
pub type PFETOVERCURRENTLIMIT_W<'a, const O: u8> = crate::BitWriter<'a, IFS_SPEC, O>;
#[doc = "Field `NFETOVERCURRENTLIMIT` writer - Set NFETOVERCURRENTLIMIT Interrupt Flag"]
pub type NFETOVERCURRENTLIMIT_W<'a, const O: u8> = crate::BitWriter<'a, IFS_SPEC, O>;
#[doc = "Field `DCDCLPRUNNING` writer - Set DCDCLPRUNNING Interrupt Flag"]
pub type DCDCLPRUNNING_W<'a, const O: u8> = crate::BitWriter<'a, IFS_SPEC, O>;
#[doc = "Field `DCDCLNRUNNING` writer - Set DCDCLNRUNNING Interrupt Flag"]
pub type DCDCLNRUNNING_W<'a, const O: u8> = crate::BitWriter<'a, IFS_SPEC, O>;
#[doc = "Field `DCDCINBYPASS` writer - Set DCDCINBYPASS Interrupt Flag"]
pub type DCDCINBYPASS_W<'a, const O: u8> = crate::BitWriter<'a, IFS_SPEC, O>;
#[doc = "Field `EM23WAKEUP` writer - Set EM23WAKEUP Interrupt Flag"]
pub type EM23WAKEUP_W<'a, const O: u8> = crate::BitWriter<'a, IFS_SPEC, O>;
#[doc = "Field `TEMP` writer - Set TEMP Interrupt Flag"]
pub type TEMP_W<'a, const O: u8> = crate::BitWriter<'a, IFS_SPEC, O>;
#[doc = "Field `TEMPLOW` writer - Set TEMPLOW Interrupt Flag"]
pub type TEMPLOW_W<'a, const O: u8> = crate::BitWriter<'a, IFS_SPEC, O>;
#[doc = "Field `TEMPHIGH` writer - Set TEMPHIGH Interrupt Flag"]
pub type TEMPHIGH_W<'a, const O: u8> = crate::BitWriter<'a, IFS_SPEC, O>;
impl W {
