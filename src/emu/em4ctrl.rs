...
pub type EM4IORETMODE_R = crate::FieldReader<EM4IORETMODE>;
...
pub type EM4IORETMODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2, EM4IORETMODE>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn em4state(&mut self) -> EM4STATE_W<EM4CTRLrs> {
        EM4STATE_W::new(self, 0)
    }
    #[doc = "Bit 1 - LFRCO Retain During EM4"]
    #[inline(always)]
    #[must_use]
    pub fn retainlfrco(&mut self) -> RETAINLFRCO_W<EM4CTRLrs> {
        RETAINLFRCO_W::new(self, 1)
    }
    #[doc = "Bit 2 - LFXO Retain During EM4"]
    #[inline(always)]
    #[must_use]
    pub fn retainlfxo(&mut self) -> RETAINLFXO_W<EM4CTRLrs> {
        RETAINLFXO_W::new(self, 2)
    }
    #[doc = "Bit 3 - ULFRCO Retain During EM4S"]
    #[inline(always)]
    #[must_use]
    pub fn retainulfrco(&mut self) -> RETAINULFRCO_W<EM4CTRLrs> {
        RETAINULFRCO_W::new(self, 3)
    }
    #[doc = "Bits 4:5 - EM4 IO Retention Disable"]
    #[inline(always)]
    #[must_use]
    pub fn em4ioretmode(&mut self) -> EM4IORETMODE_W<EM4CTRLrs> {
        EM4IORETMODE_W::new(self, 4)
    }
    #[doc = "Bits 16:17 - Energy Mode 4 Entry"]
    #[inline(always)]
    #[must_use]
    pub fn em4entry(&mut self) -> EM4ENTRY_W<EM4CTRLrs> {
