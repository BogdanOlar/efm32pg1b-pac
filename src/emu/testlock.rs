#[doc = "Reader of register TESTLOCK"]
pub type R = crate::R<u32, super::TESTLOCK>;
#[doc = "Writer for register TESTLOCK"]
pub type W = crate::W<u32, super::TESTLOCK>;
#[doc = "Register TESTLOCK `reset()`'s with value 0"]
impl crate::ResetValue for super::TESTLOCK {
    type Type = u32;
    #[inline(always)]
