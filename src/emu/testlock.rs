///Register `TESTLOCK` reader
pub type R = crate::R<TESTLOCKrs>;
///Register `TESTLOCK` writer
...
///Field `LOCKKEY` writer - Configuration Lock Key
...
impl W {
    ///Bits 0:15 - Configuration Lock Key
    #[inline(always)]
    pub fn lockkey(&mut self) -> LockkeyW<'_, TESTLOCKrs> {
        LockkeyW::new(self, 0)
    }
}
///Test Lock Register
...
///`read()` method returns [`testlock::R`](R) reader structure
impl crate::Readable for TESTLOCKrs {}
///`write(|w| ..)` method takes [`testlock::W`](W) writer structure
