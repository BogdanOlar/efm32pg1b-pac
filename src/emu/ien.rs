...
pub type VMONAVDDFALL_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type VMONAVDDRISE_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type VMONALTAVDDFALL_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type VMONALTAVDDRISE_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type VMONDVDDFALL_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type VMONDVDDRISE_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type VMONIO0FALL_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type VMONIO0RISE_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type VMONFVDDFALL_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type VMONFVDDRISE_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type PFETOVERCURRENTLIMIT_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type NFETOVERCURRENTLIMIT_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type DCDCLPRUNNING_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type DCDCLNRUNNING_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type DCDCINBYPASS_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type EM23WAKEUP_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
#[doc = "Field `TEMP` reader - TEMP Interrupt Enable"]
pub type TEMP_R = crate::BitReader;
#[doc = "Field `TEMP` writer - TEMP Interrupt Enable"]
pub type TEMP_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type TEMPLOW_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type TEMPHIGH_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
impl R {
