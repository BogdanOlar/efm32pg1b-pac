...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DCDCLNCOMPCTRL")
            .field("compenr1", &format_args!("{}", self.compenr1().bits()))
            .field("compenr2", &format_args!("{}", self.compenr2().bits()))
            .field("compenr3", &format_args!("{}", self.compenr3().bits()))
            .field("compenc1", &format_args!("{}", self.compenc1().bits()))
            .field("compenc2", &format_args!("{}", self.compenc2().bits()))
            .field("compenc3", &format_args!("{}", self.compenc3().bits()))
            .finish()
    }
}
impl core::fmt::Debug for crate::generic::Reg<DCDCLNCOMPCTRL_SPEC> {
