...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn compenr1(&mut self) -> COMPENR1_W<DCDCLNCOMPCTRLrs> {
        COMPENR1_W::new(self, 0)
    }
    #[doc = "Bits 4:8 - Low Noise Mode Compensator R2 Trim Value"]
    #[inline(always)]
    #[must_use]
    pub fn compenr2(&mut self) -> COMPENR2_W<DCDCLNCOMPCTRLrs> {
        COMPENR2_W::new(self, 4)
    }
    #[doc = "Bits 12:15 - Low Noise Mode Compensator R3 Trim Value"]
    #[inline(always)]
    #[must_use]
    pub fn compenr3(&mut self) -> COMPENR3_W<DCDCLNCOMPCTRLrs> {
        COMPENR3_W::new(self, 12)
    }
    #[doc = "Bits 20:21 - Low Noise Mode Compensator C1 Trim Value"]
    #[inline(always)]
    #[must_use]
    pub fn compenc1(&mut self) -> COMPENC1_W<DCDCLNCOMPCTRLrs> {
        COMPENC1_W::new(self, 20)
    }
    #[doc = "Bits 24:26 - Low Noise Mode Compensator C2 Trim Value"]
    #[inline(always)]
    #[must_use]
    pub fn compenc2(&mut self) -> COMPENC2_W<DCDCLNCOMPCTRLrs> {
        COMPENC2_W::new(self, 24)
    }
    #[doc = "Bits 28:31 - Low Noise Mode Compensator C3 Trim Value"]
    #[inline(always)]
    #[must_use]
    pub fn compenc3(&mut self) -> COMPENC3_W<DCDCLNCOMPCTRLrs> {
