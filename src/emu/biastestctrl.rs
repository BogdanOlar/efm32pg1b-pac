///Register `BIASTESTCTRL` reader
pub type R = crate::R<BIASTESTCTRLrs>;
///Register `BIASTESTCTRL` writer
pub type W = crate::W<BIASTESTCTRLrs>;
///Field `BIAS_RIP_RESET` reader - Reset Bias Ripple Counter
pub type BiasRipResetR = crate::BitReader;
///Field `BIAS_RIP_RESET` writer - Reset Bias Ripple Counter
...
///`read()` method returns [`biastestctrl::R`](R) reader structure
