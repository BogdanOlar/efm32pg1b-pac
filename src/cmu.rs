...
#[doc = "LFXO Control Register"]
pub mod lfxoctrl;
#[doc = "ULFRCO Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ulfrcoctrl](ulfrcoctrl) module"]
pub type ULFRCOCTRL = crate::Reg<u32, _ULFRCOCTRL>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _ULFRCOCTRL;
#[doc = "`read()` method returns [ulfrcoctrl::R](ulfrcoctrl::R) reader structure"]
impl crate::Readable for ULFRCOCTRL {}
#[doc = "`write(|w| ..)` method takes [ulfrcoctrl::W](ulfrcoctrl::W) writer structure"]
impl crate::Writable for ULFRCOCTRL {}
#[doc = "ULFRCO Control Register"]
pub mod ulfrcoctrl;
