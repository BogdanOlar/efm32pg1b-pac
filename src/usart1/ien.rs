...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rxof(&mut self) -> RXOF_W<IENrs> {
        RXOF_W::new(self, 4)
    }
    #[doc = "Bit 5 - RXUF Interrupt Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn txuf(&mut self) -> TXUF_W<IENrs> {
        TXUF_W::new(self, 7)
    }
    #[doc = "Bit 8 - PERR Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn perr(&mut self) -> PERR_W<IENrs> {
        PERR_W::new(self, 8)
    }
    #[doc = "Bit 9 - FERR Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ferr(&mut self) -> FERR_W<IENrs> {
        FERR_W::new(self, 9)
    }
    #[doc = "Bit 10 - MPAF Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn mpaf(&mut self) -> MPAF_W<IENrs> {
        MPAF_W::new(self, 10)
    }
    #[doc = "Bit 11 - SSM Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ssm(&mut self) -> SSM_W<IENrs> {
        SSM_W::new(self, 11)
    }
    #[doc = "Bit 12 - CCF Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ccf(&mut self) -> CCF_W<IENrs> {
        CCF_W::new(self, 12)
    }
    #[doc = "Bit 13 - TXIDLE Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn txidle(&mut self) -> TXIDLE_W<IENrs> {
        TXIDLE_W::new(self, 13)
    }
    #[doc = "Bit 14 - TCMP0 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn tcmp0(&mut self) -> TCMP0_W<IENrs> {
        TCMP0_W::new(self, 14)
    }
    #[doc = "Bit 15 - TCMP1 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn tcmp1(&mut self) -> TCMP1_W<IENrs> {
        TCMP1_W::new(self, 15)
    }
    #[doc = "Bit 16 - TCMP2 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn tcmp2(&mut self) -> TCMP2_W<IENrs> {
        TCMP2_W::new(self, 16)
    }
