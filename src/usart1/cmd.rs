...
pub type MASTEREN_W<'a, const O: u8> = crate::BitWriter<'a, CMD_SPEC, O>;
#[doc = "Field `MASTERDIS` writer - Master Disable"]
pub type MASTERDIS_W<'a, const O: u8> = crate::BitWriter<'a, CMD_SPEC, O>;
...
pub type TXTRIEN_W<'a, const O: u8> = crate::BitWriter<'a, CMD_SPEC, O>;
#[doc = "Field `TXTRIDIS` writer - Transmitter Tristate Disable"]
pub type TXTRIDIS_W<'a, const O: u8> = crate::BitWriter<'a, CMD_SPEC, O>;
