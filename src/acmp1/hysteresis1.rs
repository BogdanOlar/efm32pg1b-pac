///Register `HYSTERESIS1` reader
pub type R = crate::R<HYSTERESIS1rs>;
///Register `HYSTERESIS1` writer
...
///Field `HYST` reader - Hysteresis Select When ACMPOUT=1
...
///Field `HYST` writer - Hysteresis Select When ACMPOUT=1
...
///Field `DIVVA` reader - Divider for VA Voltage When ACMPOUT=1
pub type DivvaR = crate::FieldReader;
///Field `DIVVA` writer - Divider for VA Voltage When ACMPOUT=1
pub type DivvaW<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `DIVVB` reader - Divider for VB Voltage When ACMPOUT=1
pub type DivvbR = crate::FieldReader;
///Field `DIVVB` writer - Divider for VB Voltage When ACMPOUT=1
...
impl W {
    ///Bits 0:3 - Hysteresis Select When ACMPOUT=1
    #[inline(always)]
    pub fn hyst(&mut self) -> HystW<'_, HYSTERESIS1rs> {
        HystW::new(self, 0)
    }
    ///Bits 16:21 - Divider for VA Voltage When ACMPOUT=1
    #[inline(always)]
    pub fn divva(&mut self) -> DivvaW<'_, HYSTERESIS1rs> {
        DivvaW::new(self, 16)
    }
    ///Bits 24:29 - Divider for VB Voltage When ACMPOUT=1
    #[inline(always)]
    pub fn divvb(&mut self) -> DivvbW<'_, HYSTERESIS1rs> {
        DivvbW::new(self, 24)
    }
}
...
///`read()` method returns [`hysteresis1::R`](R) reader structure
impl crate::Readable for HYSTERESIS1rs {}
///`write(|w| ..)` method takes [`hysteresis1::W`](W) writer structure
