///Register `APORTREQ` reader
pub type R = crate::R<APORTREQrs>;
///Field `APORT0XREQ` reader - 1 If the Bus Connected to APORT0X is Requested
pub type Aport0xreqR = crate::BitReader;
///Field `APORT0YREQ` reader - 1 If the Bus Connected to APORT0Y is Requested
pub type Aport0yreqR = crate::BitReader;
///Field `APORT1XREQ` reader - 1 If the Bus Connected to APORT2X is Requested
pub type Aport1xreqR = crate::BitReader;
///Field `APORT1YREQ` reader - 1 If the Bus Connected to APORT1X is Requested
pub type Aport1yreqR = crate::BitReader;
///Field `APORT2XREQ` reader - 1 If the Bus Connected to APORT2X is Requested
pub type Aport2xreqR = crate::BitReader;
///Field `APORT2YREQ` reader - 1 If the Bus Connected to APORT2Y is Requested
pub type Aport2yreqR = crate::BitReader;
///Field `APORT3XREQ` reader - 1 If the Bus Connected to APORT3X is Requested
pub type Aport3xreqR = crate::BitReader;
///Field `APORT3YREQ` reader - 1 If the Bus Connected to APORT3Y is Requested
pub type Aport3yreqR = crate::BitReader;
///Field `APORT4XREQ` reader - 1 If the Bus Connected to APORT4X is Requested
pub type Aport4xreqR = crate::BitReader;
///Field `APORT4YREQ` reader - 1 If the Bus Connected to APORT4Y is Requested
