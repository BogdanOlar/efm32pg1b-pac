///Register `OVSCFG` reader
pub type R = crate::R<OVSCFGrs>;
///Register `OVSCFG` writer
pub type W = crate::W<OVSCFGrs>;
///Field `FILTLEN` reader - Configure Filter Length for Inputs S0IN and S1IN
pub type FiltlenR = crate::FieldReader;
///Field `FILTLEN` writer - Configure Filter Length for Inputs S0IN and S1IN
pub type FiltlenW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `FLUTTERRM` reader - Flutter Remove
pub type FlutterrmR = crate::BitReader;
///Field `FLUTTERRM` writer - Flutter Remove
...
///`read()` method returns [`ovscfg::R`](R) reader structure
