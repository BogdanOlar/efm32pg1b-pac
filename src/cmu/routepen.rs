...
///Field `CLKOUT0PEN` reader - CLKOUT0 Pin Enable
pub type Clkout0penR = crate::BitReader;
///Field `CLKOUT0PEN` writer - CLKOUT0 Pin Enable
pub type Clkout0penW<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CLKOUT1PEN` reader - CLKOUT1 Pin Enable
pub type Clkout1penR = crate::BitReader;
///Field `CLKOUT1PEN` writer - CLKOUT1 Pin Enable
...
impl W {
    ///Bit 0 - CLKOUT0 Pin Enable
    #[inline(always)]
    pub fn clkout0pen(&mut self) -> Clkout0penW<'_, ROUTEPENrs> {
        Clkout0penW::new(self, 0)
    }
    ///Bit 1 - CLKOUT1 Pin Enable
    #[inline(always)]
    pub fn clkout1pen(&mut self) -> Clkout1penW<'_, ROUTEPENrs> {
