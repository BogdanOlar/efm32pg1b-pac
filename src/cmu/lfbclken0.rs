///Register `LFBCLKEN0` reader
pub type R = crate::R<LFBCLKEN0rs>;
///Register `LFBCLKEN0` writer
pub type W = crate::W<LFBCLKEN0rs>;
///Field `LEUART0` reader - Low Energy UART 0 Clock Enable
pub type Leuart0R = crate::BitReader;
///Field `LEUART0` writer - Low Energy UART 0 Clock Enable
...
///`read()` method returns [`lfbclken0::R`](R) reader structure
