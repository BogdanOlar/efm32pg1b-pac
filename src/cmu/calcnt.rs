///Register `CALCNT` reader
pub type R = crate::R<CALCNTrs>;
///Register `CALCNT` writer
pub type W = crate::W<CALCNTrs>;
///Field `CALCNT` reader - Calibration Counter
pub type CalcntR = crate::FieldReader<u32>;
///Field `CALCNT` writer - Calibration Counter
...
///`read()` method returns [`calcnt::R`](R) reader structure
