...
pub type PRESC_W<'a, const O: u8> = crate::FieldWriter<'a, HFPRESC_SPEC, 5, O, PRESC_A>;
...
pub type HFCLKLEPRESC_W<'a, const O: u8> = crate::BitWriter<'a, HFPRESC_SPEC, O, HFCLKLEPRESC_A>;
