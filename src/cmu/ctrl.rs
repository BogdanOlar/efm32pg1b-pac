...
pub type CLKOUTSEL0_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O, CLKOUTSEL0_A>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CTRL")
            .field("clkoutsel0", &format_args!("{}", self.clkoutsel0().bits()))
            .field("clkoutsel1", &format_args!("{}", self.clkoutsel1().bits()))
            .field("wshfle", &format_args!("{}", self.wshfle().bit()))
            .field("hfperclken", &format_args!("{}", self.hfperclken().bit()))
            .finish()
    }
}
