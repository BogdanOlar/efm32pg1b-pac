///Register `HFXOTRIMSTATUS` reader
pub type R = crate::R<HFXOTRIMSTATUSrs>;
///Field `IBTRIMXOCORE` reader - Value of IBTRIMXOCORE Found By Automatic HFXO Peak Detection Algorithm
pub type IbtrimxocoreR = crate::FieldReader;
///Field `REGISH` reader - Value of REGISH Found By Automatic HFXO Shunt Current Optimization Algorithm
...
///`read()` method returns [`hfxotrimstatus::R`](R) reader structure
