///Register `LFACLKEN0` reader
pub type R = crate::R<LFACLKEN0rs>;
///Register `LFACLKEN0` writer
pub type W = crate::W<LFACLKEN0rs>;
///Field `LETIMER0` reader - Low Energy Timer 0 Clock Enable
pub type Letimer0R = crate::BitReader;
///Field `LETIMER0` writer - Low Energy Timer 0 Clock Enable
...
impl W {
    ///Bit 0 - Low Energy Timer 0 Clock Enable
    #[inline(always)]
    pub fn letimer0(&mut self) -> Letimer0W<'_, LFACLKEN0rs> {
...
///`read()` method returns [`lfaclken0::R`](R) reader structure
impl crate::Readable for LFACLKEN0rs {}
///`write(|w| ..)` method takes [`lfaclken0::W`](W) writer structure
