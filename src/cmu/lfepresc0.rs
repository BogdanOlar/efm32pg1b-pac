///Register `LFEPRESC0` reader
pub type R = crate::R<LFEPRESC0rs>;
///Register `LFEPRESC0` writer
...
///`read()` method returns [`lfepresc0::R`](R) reader structure
impl crate::Readable for LFEPRESC0rs {}
///`write(|w| ..)` method takes [`lfepresc0::W`](W) writer structure
