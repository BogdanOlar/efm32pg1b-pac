///Register `CH6_LINK` reader
pub type R = crate::R<CH6_LINKrs>;
///Register `CH6_LINK` writer
...
impl W {
    ///Bit 1 - Link Next Structure
    #[inline(always)]
    pub fn link(&mut self) -> LinkW<'_, CH6_LINKrs> {
        LinkW::new(self, 1)
    }
    ///Bits 2:31 - Link Structure Address
    #[inline(always)]
    pub fn linkaddr(&mut self) -> LinkaddrW<'_, CH6_LINKrs> {
...
///`read()` method returns [`ch6_link::R`](R) reader structure
impl crate::Readable for CH6_LINKrs {}
///`write(|w| ..)` method takes [`ch6_link::W`](W) writer structure
