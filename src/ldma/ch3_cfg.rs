...
pub type R = crate::R<CH3_CFGrs>;
#[doc = "Register `CH3_CFG` writer"]
pub type W = crate::W<CH3_CFGrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn arbslots(&mut self) -> ARBSLOTS_W<CH3_CFGrs> {
        ARBSLOTS_W::new(self, 16)
    }
    #[doc = "Bit 20 - Source Address Increment Sign"]
    #[inline(always)]
    #[must_use]
    pub fn srcincsign(&mut self) -> SRCINCSIGN_W<CH3_CFGrs> {
        SRCINCSIGN_W::new(self, 20)
    }
    #[doc = "Bit 21 - Destination Address Increment Sign"]
    #[inline(always)]
    #[must_use]
    pub fn dstincsign(&mut self) -> DSTINCSIGN_W<CH3_CFGrs> {
...
pub struct CH3_CFGrs;
impl crate::RegisterSpec for CH3_CFGrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch3_cfg::R`](R) reader structure"]
impl crate::Readable for CH3_CFGrs {}
