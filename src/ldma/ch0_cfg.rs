///Register `CH0_CFG` reader
pub type R = crate::R<CH0_CFGrs>;
///Register `CH0_CFG` writer
...
impl W {
    ///Bits 16:17 - Arbitration Slot Number Select
    #[inline(always)]
    pub fn arbslots(&mut self) -> ArbslotsW<'_, CH0_CFGrs> {
        ArbslotsW::new(self, 16)
    }
    ///Bit 20 - Source Address Increment Sign
    #[inline(always)]
    pub fn srcincsign(&mut self) -> SrcincsignW<'_, CH0_CFGrs> {
        SrcincsignW::new(self, 20)
    }
    ///Bit 21 - Destination Address Increment Sign
    #[inline(always)]
    pub fn dstincsign(&mut self) -> DstincsignW<'_, CH0_CFGrs> {
...
///`read()` method returns [`ch0_cfg::R`](R) reader structure
impl crate::Readable for CH0_CFGrs {}
///`write(|w| ..)` method takes [`ch0_cfg::W`](W) writer structure
impl crate::Writable for CH0_CFGrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CH0_CFG to value 0
impl crate::Resettable for CH0_CFGrs {}
