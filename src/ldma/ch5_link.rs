///Register `CH5_LINK` reader
pub type R = crate::R<CH5_LINKrs>;
///Register `CH5_LINK` writer
pub type W = crate::W<CH5_LINKrs>;
...
impl W {
    ///Bit 1 - Link Next Structure
    #[inline(always)]
    pub fn link(&mut self) -> LinkW<'_, CH5_LINKrs> {
        LinkW::new(self, 1)
    }
    ///Bits 2:31 - Link Structure Address
    #[inline(always)]
    pub fn linkaddr(&mut self) -> LinkaddrW<'_, CH5_LINKrs> {
...
pub struct CH5_LINKrs;
impl crate::RegisterSpec for CH5_LINKrs {
    type Ux = u32;
}
///`read()` method returns [`ch5_link::R`](R) reader structure
impl crate::Readable for CH5_LINKrs {}
///`write(|w| ..)` method takes [`ch5_link::W`](W) writer structure
impl crate::Writable for CH5_LINKrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CH5_LINK to value 0
impl crate::Resettable for CH5_LINKrs {}
