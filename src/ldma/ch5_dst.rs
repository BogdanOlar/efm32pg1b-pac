///Register `CH5_DST` reader
pub type R = crate::R<CH5_DSTrs>;
///Register `CH5_DST` writer
...
impl W {
    ///Bits 0:31 - Destination Data Address
    #[inline(always)]
    pub fn dstaddr(&mut self) -> DstaddrW<'_, CH5_DSTrs> {
        DstaddrW::new(self, 0)
    }
}
...
///`read()` method returns [`ch5_dst::R`](R) reader structure
impl crate::Readable for CH5_DSTrs {}
///`write(|w| ..)` method takes [`ch5_dst::W`](W) writer structure
