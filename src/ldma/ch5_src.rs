///Register `CH5_SRC` reader
pub type R = crate::R<CH5_SRCrs>;
///Register `CH5_SRC` writer
...
impl W {
    ///Bits 0:31 - Source Data Address
    #[inline(always)]
    pub fn srcaddr(&mut self) -> SrcaddrW<'_, CH5_SRCrs> {
        SrcaddrW::new(self, 0)
    }
}
...
///`read()` method returns [`ch5_src::R`](R) reader structure
impl crate::Readable for CH5_SRCrs {}
///`write(|w| ..)` method takes [`ch5_src::W`](W) writer structure
