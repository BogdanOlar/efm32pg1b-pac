///Register `CHDONE` reader
pub type R = crate::R<CHDONErs>;
///Register `CHDONE` writer
pub type W = crate::W<CHDONErs>;
///Field `CHDONE` reader - DMA Channel Linking or Done
pub type ChdoneR = crate::FieldReader;
///Field `CHDONE` writer - DMA Channel Linking or Done
...
impl W {
    ///Bits 0:7 - DMA Channel Linking or Done
    #[inline(always)]
    pub fn chdone(&mut self) -> ChdoneW<'_, CHDONErs> {
        ChdoneW::new(self, 0)
    }
}
...
///`read()` method returns [`chdone::R`](R) reader structure
impl crate::Readable for CHDONErs {}
///`write(|w| ..)` method takes [`chdone::W`](W) writer structure
