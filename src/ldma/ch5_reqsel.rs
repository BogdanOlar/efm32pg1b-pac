///Register `CH5_REQSEL` reader
pub type R = crate::R<CH5_REQSELrs>;
///Register `CH5_REQSEL` writer
pub type W = crate::W<CH5_REQSELrs>;
...
impl W {
    ///Bits 0:3 - Signal Select
    #[inline(always)]
    pub fn sigsel(&mut self) -> SigselW<'_, CH5_REQSELrs> {
        SigselW::new(self, 0)
    }
    ///Bits 16:21 - Source Select
    #[inline(always)]
    pub fn sourcesel(&mut self) -> SourceselW<'_, CH5_REQSELrs> {
...
pub struct CH5_REQSELrs;
impl crate::RegisterSpec for CH5_REQSELrs {
    type Ux = u32;
}
///`read()` method returns [`ch5_reqsel::R`](R) reader structure
impl crate::Readable for CH5_REQSELrs {}
///`write(|w| ..)` method takes [`ch5_reqsel::W`](W) writer structure
impl crate::Writable for CH5_REQSELrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CH5_REQSEL to value 0
impl crate::Resettable for CH5_REQSELrs {}
