#[doc = "Reader of register CH5_REQSEL"]
pub type R = crate::R<u32, super::CH5_REQSEL>;
#[doc = "Writer for register CH5_REQSEL"]
pub type W = crate::W<u32, super::CH5_REQSEL>;
#[doc = "Register CH5_REQSEL `reset()`'s with value 0"]
impl crate::ResetValue for super::CH5_REQSEL {
    type Type = u32;
    #[inline(always)]
