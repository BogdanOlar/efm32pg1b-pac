///Register `CH0_REQSEL` reader
pub type R = crate::R<CH0_REQSELrs>;
///Register `CH0_REQSEL` writer
pub type W = crate::W<CH0_REQSELrs>;
...
impl W {
    ///Bits 0:3 - Signal Select
    #[inline(always)]
    pub fn sigsel(&mut self) -> SigselW<'_, CH0_REQSELrs> {
        SigselW::new(self, 0)
    }
    ///Bits 16:21 - Source Select
    #[inline(always)]
    pub fn sourcesel(&mut self) -> SourceselW<'_, CH0_REQSELrs> {
...
///`read()` method returns [`ch0_reqsel::R`](R) reader structure
impl crate::Readable for CH0_REQSELrs {}
///`write(|w| ..)` method takes [`ch0_reqsel::W`](W) writer structure
impl crate::Writable for CH0_REQSELrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CH0_REQSEL to value 0
impl crate::Resettable for CH0_REQSELrs {}
