...
pub type SIGSEL_W<'a, const O: u8> = crate::FieldWriter<'a, CH0_REQSEL_SPEC, 4, O>;
...
pub type SOURCESEL_W<'a, const O: u8> = crate::FieldWriter<'a, CH0_REQSEL_SPEC, 6, O, SOURCESEL_A>;
