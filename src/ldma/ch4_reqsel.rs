///Register `CH4_REQSEL` reader
pub type R = crate::R<CH4_REQSELrs>;
///Register `CH4_REQSEL` writer
pub type W = crate::W<CH4_REQSELrs>;
...
impl W {
    ///Bits 0:3 - Signal Select
    #[inline(always)]
    pub fn sigsel(&mut self) -> SigselW<'_, CH4_REQSELrs> {
        SigselW::new(self, 0)
    }
    ///Bits 16:21 - Source Select
    #[inline(always)]
    pub fn sourcesel(&mut self) -> SourceselW<'_, CH4_REQSELrs> {
...
pub struct CH4_REQSELrs;
impl crate::RegisterSpec for CH4_REQSELrs {
    type Ux = u32;
}
///`read()` method returns [`ch4_reqsel::R`](R) reader structure
impl crate::Readable for CH4_REQSELrs {}
///`write(|w| ..)` method takes [`ch4_reqsel::W`](W) writer structure
impl crate::Writable for CH4_REQSELrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CH4_REQSEL to value 0
impl crate::Resettable for CH4_REQSELrs {}
