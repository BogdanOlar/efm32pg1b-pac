///Register `CH6_CFG` reader
pub type R = crate::R<CH6_CFGrs>;
///Register `CH6_CFG` writer
...
impl W {
    ///Bits 16:17 - Arbitration Slot Number Select
    #[inline(always)]
    pub fn arbslots(&mut self) -> ArbslotsW<'_, CH6_CFGrs> {
        ArbslotsW::new(self, 16)
    }
    ///Bit 20 - Source Address Increment Sign
    #[inline(always)]
    pub fn srcincsign(&mut self) -> SrcincsignW<'_, CH6_CFGrs> {
        SrcincsignW::new(self, 20)
    }
    ///Bit 21 - Destination Address Increment Sign
    #[inline(always)]
    pub fn dstincsign(&mut self) -> DstincsignW<'_, CH6_CFGrs> {
...
///`read()` method returns [`ch6_cfg::R`](R) reader structure
impl crate::Readable for CH6_CFGrs {}
///`write(|w| ..)` method takes [`ch6_cfg::W`](W) writer structure
