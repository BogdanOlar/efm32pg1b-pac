///Register `CH6_REQSEL` reader
pub type R = crate::R<CH6_REQSELrs>;
///Register `CH6_REQSEL` writer
...
pub struct CH6_REQSELrs;
impl crate::RegisterSpec for CH6_REQSELrs {
    type Ux = u32;
}
///`read()` method returns [`ch6_reqsel::R`](R) reader structure
