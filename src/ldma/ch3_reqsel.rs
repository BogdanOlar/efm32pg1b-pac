///Register `CH3_REQSEL` reader
pub type R = crate::R<CH3_REQSELrs>;
///Register `CH3_REQSEL` writer
pub type W = crate::W<CH3_REQSELrs>;
...
impl W {
    ///Bits 0:3 - Signal Select
    #[inline(always)]
    pub fn sigsel(&mut self) -> SigselW<'_, CH3_REQSELrs> {
        SigselW::new(self, 0)
    }
    ///Bits 16:21 - Source Select
    #[inline(always)]
    pub fn sourcesel(&mut self) -> SourceselW<'_, CH3_REQSELrs> {
...
pub struct CH3_REQSELrs;
impl crate::RegisterSpec for CH3_REQSELrs {
    type Ux = u32;
}
///`read()` method returns [`ch3_reqsel::R`](R) reader structure
impl crate::Readable for CH3_REQSELrs {}
///`write(|w| ..)` method takes [`ch3_reqsel::W`](W) writer structure
impl crate::Writable for CH3_REQSELrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CH3_REQSEL to value 0
impl crate::Resettable for CH3_REQSELrs {}
