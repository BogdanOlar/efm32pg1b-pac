///Register `CH7_CFG` reader
pub type R = crate::R<CH7_CFGrs>;
///Register `CH7_CFG` writer
pub type W = crate::W<CH7_CFGrs>;
...
impl W {
    ///Bits 16:17 - Arbitration Slot Number Select
    #[inline(always)]
    pub fn arbslots(&mut self) -> ArbslotsW<'_, CH7_CFGrs> {
        ArbslotsW::new(self, 16)
    }
    ///Bit 20 - Source Address Increment Sign
    #[inline(always)]
    pub fn srcincsign(&mut self) -> SrcincsignW<'_, CH7_CFGrs> {
        SrcincsignW::new(self, 20)
    }
    ///Bit 21 - Destination Address Increment Sign
    #[inline(always)]
    pub fn dstincsign(&mut self) -> DstincsignW<'_, CH7_CFGrs> {
...
pub struct CH7_CFGrs;
impl crate::RegisterSpec for CH7_CFGrs {
    type Ux = u32;
}
///`read()` method returns [`ch7_cfg::R`](R) reader structure
impl crate::Readable for CH7_CFGrs {}
///`write(|w| ..)` method takes [`ch7_cfg::W`](W) writer structure
impl crate::Writable for CH7_CFGrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CH7_CFG to value 0
impl crate::Resettable for CH7_CFGrs {}
