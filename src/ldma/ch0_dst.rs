///Register `CH0_DST` reader
pub type R = crate::R<CH0_DSTrs>;
///Register `CH0_DST` writer
pub type W = crate::W<CH0_DSTrs>;
...
pub struct CH0_DSTrs;
impl crate::RegisterSpec for CH0_DSTrs {
    type Ux = u32;
}
///`read()` method returns [`ch0_dst::R`](R) reader structure
impl crate::Readable for CH0_DSTrs {}
