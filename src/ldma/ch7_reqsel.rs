///Register `CH7_REQSEL` reader
pub type R = crate::R<CH7_REQSELrs>;
///Register `CH7_REQSEL` writer
pub type W = crate::W<CH7_REQSELrs>;
...
impl W {
    ///Bits 0:3 - Signal Select
    #[inline(always)]
    pub fn sigsel(&mut self) -> SigselW<'_, CH7_REQSELrs> {
        SigselW::new(self, 0)
    }
    ///Bits 16:21 - Source Select
    #[inline(always)]
    pub fn sourcesel(&mut self) -> SourceselW<'_, CH7_REQSELrs> {
...
pub struct CH7_REQSELrs;
impl crate::RegisterSpec for CH7_REQSELrs {
    type Ux = u32;
}
///`read()` method returns [`ch7_reqsel::R`](R) reader structure
impl crate::Readable for CH7_REQSELrs {}
///`write(|w| ..)` method takes [`ch7_reqsel::W`](W) writer structure
impl crate::Writable for CH7_REQSELrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CH7_REQSEL to value 0
impl crate::Resettable for CH7_REQSELrs {}
