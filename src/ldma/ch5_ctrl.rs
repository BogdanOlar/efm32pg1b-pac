///Register `CH5_CTRL` reader
pub type R = crate::R<CH5_CTRLrs>;
///Register `CH5_CTRL` writer
pub type W = crate::W<CH5_CTRLrs>;
///DMA Structure Type
///
///Value on reset: 0
...
impl W {
    ...
    #[inline(always)]
    pub fn structreq(&mut self) -> StructreqW<'_, CH5_CTRLrs> {
        StructreqW::new(self, 3)
    }
    ///Bits 4:14 - DMA Unit Data Transfer Count
    #[inline(always)]
    pub fn xfercnt(&mut self) -> XfercntW<'_, CH5_CTRLrs> {
        XfercntW::new(self, 4)
    }
    ///Bit 15 - Endian Byte Swap
    #[inline(always)]
    pub fn byteswap(&mut self) -> ByteswapW<'_, CH5_CTRLrs> {
        ByteswapW::new(self, 15)
    }
    ///Bits 16:19 - Block Transfer Size
    #[inline(always)]
    pub fn blocksize(&mut self) -> BlocksizeW<'_, CH5_CTRLrs> {
        BlocksizeW::new(self, 16)
    }
    ///Bit 20 - DMA Operation Done Interrupt Flag Set Enable
    #[inline(always)]
    pub fn doneifsen(&mut self) -> DoneifsenW<'_, CH5_CTRLrs> {
        DoneifsenW::new(self, 20)
    }
    ///Bit 21 - DMA Request Transfer Mode Select
    #[inline(always)]
    pub fn reqmode(&mut self) -> ReqmodeW<'_, CH5_CTRLrs> {
        ReqmodeW::new(self, 21)
    }
    ///Bit 22 - Decrement Loop Count
    #[inline(always)]
    pub fn decloopcnt(&mut self) -> DecloopcntW<'_, CH5_CTRLrs> {
        DecloopcntW::new(self, 22)
    }
    ///Bit 23 - Ignore Sreq
    #[inline(always)]
    pub fn ignoresreq(&mut self) -> IgnoresreqW<'_, CH5_CTRLrs> {
        IgnoresreqW::new(self, 23)
    }
    ///Bits 24:25 - Source Address Increment Size
    #[inline(always)]
    pub fn srcinc(&mut self) -> SrcincW<'_, CH5_CTRLrs> {
        SrcincW::new(self, 24)
    }
    ///Bits 26:27 - Unit Data Transfer Size
    #[inline(always)]
    pub fn size(&mut self) -> SizeW<'_, CH5_CTRLrs> {
        SizeW::new(self, 26)
    }
    ///Bits 28:29 - Destination Address Increment Size
    #[inline(always)]
    pub fn dstinc(&mut self) -> DstincW<'_, CH5_CTRLrs> {
        DstincW::new(self, 28)
    }
}
...
pub struct CH5_CTRLrs;
impl crate::RegisterSpec for CH5_CTRLrs {
    type Ux = u32;
}
///`read()` method returns [`ch5_ctrl::R`](R) reader structure
impl crate::Readable for CH5_CTRLrs {}
///`write(|w| ..)` method takes [`ch5_ctrl::W`](W) writer structure
impl crate::Writable for CH5_CTRLrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CH5_CTRL to value 0
impl crate::Resettable for CH5_CTRLrs {}
