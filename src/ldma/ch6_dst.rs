///Register `CH6_DST` reader
pub type R = crate::R<CH6_DSTrs>;
///Register `CH6_DST` writer
...
impl W {
    ///Bits 0:31 - Destination Data Address
    #[inline(always)]
    pub fn dstaddr(&mut self) -> DstaddrW<'_, CH6_DSTrs> {
        DstaddrW::new(self, 0)
    }
}
...
///`read()` method returns [`ch6_dst::R`](R) reader structure
impl crate::Readable for CH6_DSTrs {}
///`write(|w| ..)` method takes [`ch6_dst::W`](W) writer structure
