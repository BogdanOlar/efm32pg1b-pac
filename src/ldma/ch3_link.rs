///Register `CH3_LINK` reader
pub type R = crate::R<CH3_LINKrs>;
///Register `CH3_LINK` writer
pub type W = crate::W<CH3_LINKrs>;
...
impl W {
    ///Bit 1 - Link Next Structure
    #[inline(always)]
    pub fn link(&mut self) -> LinkW<'_, CH3_LINKrs> {
        LinkW::new(self, 1)
    }
    ///Bits 2:31 - Link Structure Address
    #[inline(always)]
    pub fn linkaddr(&mut self) -> LinkaddrW<'_, CH3_LINKrs> {
...
pub struct CH3_LINKrs;
impl crate::RegisterSpec for CH3_LINKrs {
    type Ux = u32;
}
///`read()` method returns [`ch3_link::R`](R) reader structure
impl crate::Readable for CH3_LINKrs {}
///`write(|w| ..)` method takes [`ch3_link::W`](W) writer structure
impl crate::Writable for CH3_LINKrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CH3_LINK to value 0
impl crate::Resettable for CH3_LINKrs {}
