///Register `CH4_LINK` reader
pub type R = crate::R<CH4_LINKrs>;
///Register `CH4_LINK` writer
pub type W = crate::W<CH4_LINKrs>;
...
impl W {
    ///Bit 1 - Link Next Structure
    #[inline(always)]
    pub fn link(&mut self) -> LinkW<'_, CH4_LINKrs> {
        LinkW::new(self, 1)
    }
    ///Bits 2:31 - Link Structure Address
    #[inline(always)]
    pub fn linkaddr(&mut self) -> LinkaddrW<'_, CH4_LINKrs> {
...
pub struct CH4_LINKrs;
impl crate::RegisterSpec for CH4_LINKrs {
    type Ux = u32;
}
///`read()` method returns [`ch4_link::R`](R) reader structure
impl crate::Readable for CH4_LINKrs {}
///`write(|w| ..)` method takes [`ch4_link::W`](W) writer structure
impl crate::Writable for CH4_LINKrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CH4_LINK to value 0
impl crate::Resettable for CH4_LINKrs {}
