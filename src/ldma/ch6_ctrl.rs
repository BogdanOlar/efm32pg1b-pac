...
pub type STRUCTREQ_W<'a, const O: u8> = crate::BitWriter<'a, CH6_CTRL_SPEC, O>;
...
pub type XFERCNT_W<'a, const O: u8> = crate::FieldWriter<'a, CH6_CTRL_SPEC, 11, O, u16>;
#[doc = "Field `BYTESWAP` reader - Endian Byte Swap"]
pub type BYTESWAP_R = crate::BitReader;
#[doc = "Field `BYTESWAP` writer - Endian Byte Swap"]
pub type BYTESWAP_W<'a, const O: u8> = crate::BitWriter<'a, CH6_CTRL_SPEC, O>;
...
pub type BLOCKSIZE_W<'a, const O: u8> = crate::FieldWriter<'a, CH6_CTRL_SPEC, 4, O, BLOCKSIZE_A>;
...
pub type DONEIFSEN_W<'a, const O: u8> = crate::BitWriter<'a, CH6_CTRL_SPEC, O>;
...
pub type REQMODE_W<'a, const O: u8> = crate::BitWriter<'a, CH6_CTRL_SPEC, O>;
...
pub type DECLOOPCNT_W<'a, const O: u8> = crate::BitWriter<'a, CH6_CTRL_SPEC, O>;
#[doc = "Field `IGNORESREQ` reader - Ignore Sreq"]
pub type IGNORESREQ_R = crate::BitReader;
#[doc = "Field `IGNORESREQ` writer - Ignore Sreq"]
pub type IGNORESREQ_W<'a, const O: u8> = crate::BitWriter<'a, CH6_CTRL_SPEC, O>;
...
pub type SRCINC_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CH6_CTRL_SPEC, 2, O, SRCINC_A>;
...
pub type SIZE_W<'a, const O: u8> = crate::FieldWriter<'a, CH6_CTRL_SPEC, 2, O, SIZE_A>;
...
pub type DSTINC_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CH6_CTRL_SPEC, 2, O, DSTINC_A>;
