///Register `EXTIPINSELH` reader
pub type R = crate::R<EXTIPINSELHrs>;
///Register `EXTIPINSELH` writer
...
///Field `EXTIPINSEL8` reader - External Interrupt 8 Pin Select
...
///Field `EXTIPINSEL8` writer - External Interrupt 8 Pin Select
...
///Field `EXTIPINSEL9` reader - External Interrupt 9 Pin Select
...
///Field `EXTIPINSEL9` writer - External Interrupt 9 Pin Select
...
///Field `EXTIPINSEL10` reader - External Interrupt 10 Pin Select
...
///Field `EXTIPINSEL10` writer - External Interrupt 10 Pin Select
...
///Field `EXTIPINSEL11` reader - External Interrupt 11 Pin Select
...
///Field `EXTIPINSEL11` writer - External Interrupt 11 Pin Select
...
///Field `EXTIPINSEL12` reader - External Interrupt 12 Pin Select
...
///Field `EXTIPINSEL12` writer - External Interrupt 12 Pin Select
...
///Field `EXTIPINSEL13` reader - External Interrupt 13 Pin Select
...
///Field `EXTIPINSEL13` writer - External Interrupt 13 Pin Select
...
///Field `EXTIPINSEL14` reader - External Interrupt 14 Pin Select
...
///Field `EXTIPINSEL14` writer - External Interrupt 14 Pin Select
...
///Field `EXTIPINSEL15` reader - External Interrupt 15 Pin Select
...
///Field `EXTIPINSEL15` writer - External Interrupt 15 Pin Select
...
impl W {
    ///Bits 0:1 - External Interrupt 8 Pin Select
    #[inline(always)]
    pub fn extipinsel8(&mut self) -> Extipinsel8W<'_, EXTIPINSELHrs> {
        Extipinsel8W::new(self, 0)
    }
    ///Bits 4:5 - External Interrupt 9 Pin Select
    #[inline(always)]
    pub fn extipinsel9(&mut self) -> Extipinsel9W<'_, EXTIPINSELHrs> {
        Extipinsel9W::new(self, 4)
    }
    ///Bits 8:9 - External Interrupt 10 Pin Select
    #[inline(always)]
    pub fn extipinsel10(&mut self) -> Extipinsel10W<'_, EXTIPINSELHrs> {
        Extipinsel10W::new(self, 8)
    }
    ///Bits 12:13 - External Interrupt 11 Pin Select
    #[inline(always)]
    pub fn extipinsel11(&mut self) -> Extipinsel11W<'_, EXTIPINSELHrs> {
        Extipinsel11W::new(self, 12)
    }
    ///Bits 16:17 - External Interrupt 12 Pin Select
    #[inline(always)]
    pub fn extipinsel12(&mut self) -> Extipinsel12W<'_, EXTIPINSELHrs> {
        Extipinsel12W::new(self, 16)
    }
    ///Bits 20:21 - External Interrupt 13 Pin Select
    #[inline(always)]
    pub fn extipinsel13(&mut self) -> Extipinsel13W<'_, EXTIPINSELHrs> {
        Extipinsel13W::new(self, 20)
    }
    ///Bits 24:25 - External Interrupt 14 Pin Select
    #[inline(always)]
    pub fn extipinsel14(&mut self) -> Extipinsel14W<'_, EXTIPINSELHrs> {
        Extipinsel14W::new(self, 24)
    }
    ///Bits 28:29 - External Interrupt 15 Pin Select
    #[inline(always)]
    pub fn extipinsel15(&mut self) -> Extipinsel15W<'_, EXTIPINSELHrs> {
...
///`read()` method returns [`extipinselh::R`](R) reader structure
impl crate::Readable for EXTIPINSELHrs {}
///`write(|w| ..)` method takes [`extipinselh::W`](W) writer structure
