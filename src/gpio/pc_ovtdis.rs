...
pub type R = crate::R<PC_OVTDISrs>;
#[doc = "Register `PC_OVTDIS` writer"]
pub type W = crate::W<PC_OVTDISrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ovtdis(&mut self) -> OVTDIS_W<PC_OVTDISrs> {
        OVTDIS_W::new(self, 0)
    }
...
pub struct PC_OVTDISrs;
impl crate::RegisterSpec for PC_OVTDISrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pc_ovtdis::R`](R) reader structure"]
impl crate::Readable for PC_OVTDISrs {}
#[doc = "`write(|w| ..)` method takes [`pc_ovtdis::W`](W) writer structure"]
impl crate::Writable for PC_OVTDISrs {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PC_OVTDIS to value 0"]
impl crate::Resettable for PC_OVTDISrs {
