...
pub type DRIVESTRENGTH_W<'a, const O: u8> = crate::BitWriter<'a, PA_CTRL_SPEC, O>;
...
pub type SLEWRATE_W<'a, const O: u8> = crate::FieldWriter<'a, PA_CTRL_SPEC, 3, O>;
#[doc = "Field `DINDIS` reader - Data in Disable"]
pub type DINDIS_R = crate::BitReader;
#[doc = "Field `DINDIS` writer - Data in Disable"]
pub type DINDIS_W<'a, const O: u8> = crate::BitWriter<'a, PA_CTRL_SPEC, O>;
...
pub type DRIVESTRENGTHALT_W<'a, const O: u8> = crate::BitWriter<'a, PA_CTRL_SPEC, O>;
...
pub type SLEWRATEALT_W<'a, const O: u8> = crate::FieldWriter<'a, PA_CTRL_SPEC, 3, O>;
...
pub type DINDISALT_W<'a, const O: u8> = crate::BitWriter<'a, PA_CTRL_SPEC, O>;
impl R {
