...
pub type R = crate::R<PF_PINLOCKNrs>;
#[doc = "Register `PF_PINLOCKN` writer"]
pub type W = crate::W<PF_PINLOCKNrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pinlockn(&mut self) -> PINLOCKN_W<PF_PINLOCKNrs> {
...
pub struct PF_PINLOCKNrs;
impl crate::RegisterSpec for PF_PINLOCKNrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pf_pinlockn::R`](R) reader structure"]
impl crate::Readable for PF_PINLOCKNrs {}
#[doc = "`write(|w| ..)` method takes [`pf_pinlockn::W`](W) writer structure"]
impl crate::Writable for PF_PINLOCKNrs {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PF_PINLOCKN to value 0xffff"]
impl crate::Resettable for PF_PINLOCKNrs {
