...
pub type R = crate::R<PE_DOUTrs>;
#[doc = "Register `PE_DOUT` writer"]
pub type W = crate::W<PE_DOUTrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dout(&mut self) -> DOUT_W<PE_DOUTrs> {
        DOUT_W::new(self, 0)
    }
