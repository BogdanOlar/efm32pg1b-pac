///Register `EXTIPINSELL` reader
pub type R = crate::R<EXTIPINSELLrs>;
///Register `EXTIPINSELL` writer
...
///Field `EXTIPINSEL0` reader - External Interrupt 0 Pin Select
...
///Field `EXTIPINSEL0` writer - External Interrupt 0 Pin Select
...
///Field `EXTIPINSEL1` reader - External Interrupt 1 Pin Select
...
///Field `EXTIPINSEL1` writer - External Interrupt 1 Pin Select
...
///Field `EXTIPINSEL2` reader - External Interrupt 2 Pin Select
...
///Field `EXTIPINSEL2` writer - External Interrupt 2 Pin Select
...
///Field `EXTIPINSEL3` reader - External Interrupt 3 Pin Select
...
///Field `EXTIPINSEL3` writer - External Interrupt 3 Pin Select
...
///Field `EXTIPINSEL4` reader - External Interrupt 4 Pin Select
...
///Field `EXTIPINSEL4` writer - External Interrupt 4 Pin Select
...
///Field `EXTIPINSEL5` reader - External Interrupt 5 Pin Select
...
///Field `EXTIPINSEL5` writer - External Interrupt 5 Pin Select
...
///Field `EXTIPINSEL6` reader - External Interrupt 6 Pin Select
...
///Field `EXTIPINSEL6` writer - External Interrupt 6 Pin Select
...
///Field `EXTIPINSEL7` reader - External Interrupt 7 Pin Select
...
///Field `EXTIPINSEL7` writer - External Interrupt 7 Pin Select
...
///`read()` method returns [`extipinsell::R`](R) reader structure
