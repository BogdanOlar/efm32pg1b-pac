...
pub type W = crate::W<PF_DOUTTGLrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn douttgl(&mut self) -> DOUTTGL_W<PF_DOUTTGLrs> {
...
pub struct PF_DOUTTGLrs;
impl crate::RegisterSpec for PF_DOUTTGLrs {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`pf_douttgl::W`](W) writer structure"]
impl crate::Writable for PF_DOUTTGLrs {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PF_DOUTTGL to value 0"]
impl crate::Resettable for PF_DOUTTGLrs {
