...
pub type W = crate::W<PE_DOUTTGLrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn douttgl(&mut self) -> DOUTTGL_W<PE_DOUTTGLrs> {
...
pub struct PE_DOUTTGLrs;
impl crate::RegisterSpec for PE_DOUTTGLrs {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`pe_douttgl::W`](W) writer structure"]
impl crate::Writable for PE_DOUTTGLrs {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PE_DOUTTGL to value 0"]
impl crate::Resettable for PE_DOUTTGLrs {
