...
impl OSCSEL_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> Option<OSCSEL_A> {
        match self.bits {
...
pub type OSCSEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O, OSCSEL_A>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CTRL")
            ...
            .field("oscsel", &format_args!("{}", self.oscsel().bits()))
