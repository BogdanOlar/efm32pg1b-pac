...
pub type CLHR_R = crate::FieldReader<CLHR>;
...
pub type CLHR_W<'a, REG> = crate::FieldWriter<'a, REG, 2, CLHR>;
...
pub type BITO_R = crate::FieldReader<BITO>;
...
pub type BITO_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 2, BITO>;
...
pub type CLTO_R = crate::FieldReader<CLTO>;
...
pub type CLTO_W<'a, REG> = crate::FieldWriter<'a, REG, 3, CLTO>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slave(&mut self) -> SLAVE_W<CTRLrs> {
        SLAVE_W::new(self, 1)
    }
    #[doc = "Bit 2 - Automatic Acknowledge"]
    #[inline(always)]
    #[must_use]
    pub fn autoack(&mut self) -> AUTOACK_W<CTRLrs> {
        AUTOACK_W::new(self, 2)
    }
    #[doc = "Bit 3 - Automatic STOP When Empty"]
    #[inline(always)]
    #[must_use]
    pub fn autose(&mut self) -> AUTOSE_W<CTRLrs> {
        AUTOSE_W::new(self, 3)
    }
    #[doc = "Bit 4 - Automatic STOP on NACK"]
    #[inline(always)]
    #[must_use]
    pub fn autosn(&mut self) -> AUTOSN_W<CTRLrs> {
        AUTOSN_W::new(self, 4)
    }
    #[doc = "Bit 5 - Arbitration Disable"]
    #[inline(always)]
    #[must_use]
    pub fn arbdis(&mut self) -> ARBDIS_W<CTRLrs> {
        ARBDIS_W::new(self, 5)
    }
    #[doc = "Bit 6 - General Call Address Match Enable"]
    #[inline(always)]
    #[must_use]
    pub fn gcamen(&mut self) -> GCAMEN_W<CTRLrs> {
        GCAMEN_W::new(self, 6)
    }
    #[doc = "Bit 7 - TX Buffer Interrupt Level"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn clhr(&mut self) -> CLHR_W<CTRLrs> {
        CLHR_W::new(self, 8)
    }
    #[doc = "Bits 12:13 - Bus Idle Timeout"]
    #[inline(always)]
    #[must_use]
    pub fn bito(&mut self) -> BITO_W<CTRLrs> {
        BITO_W::new(self, 12)
    }
    #[doc = "Bit 15 - Go Idle on Bus Idle Timeout"]
    #[inline(always)]
    #[must_use]
    pub fn gibito(&mut self) -> GIBITO_W<CTRLrs> {
        GIBITO_W::new(self, 15)
    }
    #[doc = "Bits 16:18 - Clock Low Timeout"]
    #[inline(always)]
    #[must_use]
    pub fn clto(&mut self) -> CLTO_W<CTRLrs> {
        CLTO_W::new(self, 16)
    }
