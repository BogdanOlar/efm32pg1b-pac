///Register `SADDRMASK` reader
pub type R = crate::R<SADDRMASKrs>;
///Register `SADDRMASK` writer
pub type W = crate::W<SADDRMASKrs>;
///Field `MASK` reader - Slave Address Mask
pub type MaskR = crate::FieldReader;
///Field `MASK` writer - Slave Address Mask
...
///`read()` method returns [`saddrmask::R`](R) reader structure
