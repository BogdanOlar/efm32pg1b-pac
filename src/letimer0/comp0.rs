///Register `COMP0` reader
pub type R = crate::R<COMP0rs>;
///Register `COMP0` writer
pub type W = crate::W<COMP0rs>;
///Field `COMP0` reader - Compare Value 0
pub type Comp0R = crate::FieldReader<u16>;
///Field `COMP0` writer - Compare Value 0
...
impl W {
    ///Bits 0:15 - Compare Value 0
    #[inline(always)]
    pub fn comp0(&mut self) -> Comp0W<'_, COMP0rs> {
        Comp0W::new(self, 0)
    }
}
...
///`read()` method returns [`comp0::R`](R) reader structure
impl crate::Readable for COMP0rs {}
///`write(|w| ..)` method takes [`comp0::W`](W) writer structure
