...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dirchg(&mut self) -> DIRCHG_W<IENrs> {
        DIRCHG_W::new(self, 2)
    }
    #[doc = "Bit 4 - CC0 Interrupt Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc3(&mut self) -> CC3_W<IENrs> {
        CC3_W::new(self, 7)
    }
    #[doc = "Bit 8 - ICBOF0 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn icbof0(&mut self) -> ICBOF0_W<IENrs> {
        ICBOF0_W::new(self, 8)
    }
    #[doc = "Bit 9 - ICBOF1 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn icbof1(&mut self) -> ICBOF1_W<IENrs> {
        ICBOF1_W::new(self, 9)
    }
    #[doc = "Bit 10 - ICBOF2 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn icbof2(&mut self) -> ICBOF2_W<IENrs> {
        ICBOF2_W::new(self, 10)
    }
    #[doc = "Bit 11 - ICBOF3 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn icbof3(&mut self) -> ICBOF3_W<IENrs> {
