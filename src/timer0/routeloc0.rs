...
///Field `CC0LOC` reader - I/O Location
...
///Field `CC0LOC` writer - I/O Location
...
///Field `CC1LOC` reader - I/O Location
...
///Field `CC1LOC` writer - I/O Location
...
///Field `CC2LOC` reader - I/O Location
...
///Field `CC2LOC` writer - I/O Location
...
///Field `CC3LOC` reader - I/O Location
...
///Field `CC3LOC` writer - I/O Location
...
impl W {
    ///Bits 0:5 - I/O Location
    #[inline(always)]
    pub fn cc0loc(&mut self) -> Cc0locW<'_, ROUTELOC0rs> {
        Cc0locW::new(self, 0)
    }
    ///Bits 8:13 - I/O Location
    #[inline(always)]
    pub fn cc1loc(&mut self) -> Cc1locW<'_, ROUTELOC0rs> {
        Cc1locW::new(self, 8)
    }
    ///Bits 16:21 - I/O Location
    #[inline(always)]
    pub fn cc2loc(&mut self) -> Cc2locW<'_, ROUTELOC0rs> {
        Cc2locW::new(self, 16)
    }
    ///Bits 24:29 - I/O Location
    #[inline(always)]
    pub fn cc3loc(&mut self) -> Cc3locW<'_, ROUTELOC0rs> {
        Cc3locW::new(self, 24)
    }
}
