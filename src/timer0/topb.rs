///Register `TOPB` reader
pub type R = crate::R<TOPBrs>;
///Register `TOPB` writer
pub type W = crate::W<TOPBrs>;
///Field `TOPB` reader - Counter Top Value Buffer
pub type TopbR = crate::FieldReader<u16>;
///Field `TOPB` writer - Counter Top Value Buffer
...
///`read()` method returns [`topb::R`](R) reader structure
