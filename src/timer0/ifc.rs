...
impl W {
    ...
    #[inline(always)]
    pub fn dirchg(&mut self) -> DirchgW<'_, IFCrs> {
        DirchgW::new(self, 2)
    }
    ...
    #[inline(always)]
    pub fn cc3(&mut self) -> Cc3W<'_, IFCrs> {
        Cc3W::new(self, 7)
    }
    ///Bit 8 - Clear ICBOF0 Interrupt Flag
    #[inline(always)]
    pub fn icbof0(&mut self) -> Icbof0W<'_, IFCrs> {
        Icbof0W::new(self, 8)
    }
    ///Bit 9 - Clear ICBOF1 Interrupt Flag
    #[inline(always)]
    pub fn icbof1(&mut self) -> Icbof1W<'_, IFCrs> {
        Icbof1W::new(self, 9)
    }
    ///Bit 10 - Clear ICBOF2 Interrupt Flag
    #[inline(always)]
    pub fn icbof2(&mut self) -> Icbof2W<'_, IFCrs> {
        Icbof2W::new(self, 10)
    }
    ///Bit 11 - Clear ICBOF3 Interrupt Flag
    #[inline(always)]
    pub fn icbof3(&mut self) -> Icbof3W<'_, IFCrs> {
        Icbof3W::new(self, 11)
    }
}
