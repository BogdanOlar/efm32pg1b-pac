...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dtprs0fc(&mut self) -> DTPRS0FC_W<DTFAULTCrs> {
        DTPRS0FC_W::new(self, 0)
    }
    #[doc = "Bit 1 - DTI PRS1 Fault Clear"]
    #[inline(always)]
    #[must_use]
    pub fn dtprs1fc(&mut self) -> DTPRS1FC_W<DTFAULTCrs> {
        DTPRS1FC_W::new(self, 1)
    }
    #[doc = "Bit 2 - DTI Debugger Fault Clear"]
    #[inline(always)]
    #[must_use]
    pub fn dtdbgfc(&mut self) -> DTDBGFC_W<DTFAULTCrs> {
        DTDBGFC_W::new(self, 2)
    }
    #[doc = "Bit 3 - DTI Lockup Fault Clear"]
    #[inline(always)]
    #[must_use]
    pub fn tlockupfc(&mut self) -> TLOCKUPFC_W<DTFAULTCrs> {
