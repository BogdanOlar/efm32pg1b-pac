///Register `CC3_CCVB` reader
pub type R = crate::R<CC3_CCVBrs>;
///Register `CC3_CCVB` writer
...
impl W {
    ///Bits 0:15 - CC Channel Value Buffer
    #[inline(always)]
    pub fn ccvb(&mut self) -> CcvbW<'_, CC3_CCVBrs> {
        CcvbW::new(self, 0)
    }
}
...
///`read()` method returns [`cc3_ccvb::R`](R) reader structure
impl crate::Readable for CC3_CCVBrs {}
///`write(|w| ..)` method takes [`cc3_ccvb::W`](W) writer structure
