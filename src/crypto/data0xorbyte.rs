///Register `DATA0XORBYTE` reader
pub type R = crate::R<DATA0XORBYTErs>;
///Register `DATA0XORBYTE` writer
pub type W = crate::W<DATA0XORBYTErs>;
///Field `DATA0XORBYTE` reader - Data 0 XOR Byte Access
pub type Data0xorbyteR = crate::FieldReader;
///Field `DATA0XORBYTE` writer - Data 0 XOR Byte Access
...
impl W {
    ///Bits 0:7 - Data 0 XOR Byte Access
    #[inline(always)]
    pub fn data0xorbyte(&mut self) -> Data0xorbyteW<'_, DATA0XORBYTErs> {
...
///`read()` method returns [`data0xorbyte::R`](R) reader structure
impl crate::Readable for DATA0XORBYTErs {}
///`write(|w| ..)` method takes [`data0xorbyte::W`](W) writer structure
