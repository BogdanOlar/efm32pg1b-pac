///Register `QDATA0BYTE` reader
pub type R = crate::R<QDATA0BYTErs>;
///Register `QDATA0BYTE` writer
pub type W = crate::W<QDATA0BYTErs>;
///Field `QDATA0BYTE` reader - Qdata 0 Byte Access
pub type Qdata0byteR = crate::FieldReader;
///Field `QDATA0BYTE` writer - Qdata 0 Byte Access
...
impl W {
    ///Bits 0:7 - Qdata 0 Byte Access
    #[inline(always)]
    pub fn qdata0byte(&mut self) -> Qdata0byteW<'_, QDATA0BYTErs> {
...
///`read()` method returns [`qdata0byte::R`](R) reader structure
impl crate::Readable for QDATA0BYTErs {}
///`write(|w| ..)` method takes [`qdata0byte::W`](W) writer structure
