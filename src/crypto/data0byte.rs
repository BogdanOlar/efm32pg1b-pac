///Register `DATA0BYTE` reader
pub type R = crate::R<DATA0BYTErs>;
///Register `DATA0BYTE` writer
pub type W = crate::W<DATA0BYTErs>;
///Field `DATA0BYTE` reader - Data 0 Byte Access
pub type Data0byteR = crate::FieldReader;
///Field `DATA0BYTE` writer - Data 0 Byte Access
...
impl W {
    ///Bits 0:7 - Data 0 Byte Access
    #[inline(always)]
    pub fn data0byte(&mut self) -> Data0byteW<'_, DATA0BYTErs> {
...
///`read()` method returns [`data0byte::R`](R) reader structure
impl crate::Readable for DATA0BYTErs {}
///`write(|w| ..)` method takes [`data0byte::W`](W) writer structure
