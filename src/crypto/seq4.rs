...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn instr16(&mut self) -> INSTR16_W<SEQ4rs> {
        INSTR16_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Sequence Instruction 17"]
    #[inline(always)]
    #[must_use]
    pub fn instr17(&mut self) -> INSTR17_W<SEQ4rs> {
        INSTR17_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Sequence Instruction 18"]
    #[inline(always)]
    #[must_use]
    pub fn instr18(&mut self) -> INSTR18_W<SEQ4rs> {
        INSTR18_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Sequence Instruction 19"]
    #[inline(always)]
    #[must_use]
    pub fn instr19(&mut self) -> INSTR19_W<SEQ4rs> {
