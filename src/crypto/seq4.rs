...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SEQ4")
            .field("instr16", &format_args!("{}", self.instr16().bits()))
            .field("instr17", &format_args!("{}", self.instr17().bits()))
            .field("instr18", &format_args!("{}", self.instr18().bits()))
            .field("instr19", &format_args!("{}", self.instr19().bits()))
            .finish()
    }
}
impl core::fmt::Debug for crate::generic::Reg<SEQ4_SPEC> {
