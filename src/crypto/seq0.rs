...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn instr0(&mut self) -> INSTR0_W<SEQ0rs> {
        INSTR0_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Sequence Instruction 1"]
    #[inline(always)]
    #[must_use]
    pub fn instr1(&mut self) -> INSTR1_W<SEQ0rs> {
        INSTR1_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Sequence Instruction 2"]
    #[inline(always)]
    #[must_use]
    pub fn instr2(&mut self) -> INSTR2_W<SEQ0rs> {
        INSTR2_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Sequence Instruction 3"]
    #[inline(always)]
    #[must_use]
    pub fn instr3(&mut self) -> INSTR3_W<SEQ0rs> {
