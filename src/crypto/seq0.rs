...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SEQ0")
            .field("instr0", &format_args!("{}", self.instr0().bits()))
            .field("instr1", &format_args!("{}", self.instr1().bits()))
            .field("instr2", &format_args!("{}", self.instr2().bits()))
            .field("instr3", &format_args!("{}", self.instr3().bits()))
            .finish()
    }
}
impl core::fmt::Debug for crate::generic::Reg<SEQ0_SPEC> {
