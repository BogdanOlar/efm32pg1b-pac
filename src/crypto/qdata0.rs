///Register `QDATA0` reader
pub type R = crate::R<QDATA0rs>;
///Register `QDATA0` writer
pub type W = crate::W<QDATA0rs>;
///Field `QDATA0` reader - Quad Data 0 Access
pub type Qdata0R = crate::FieldReader<u32>;
///Field `QDATA0` writer - Quad Data 0 Access
...
///`read()` method returns [`qdata0::R`](R) reader structure
