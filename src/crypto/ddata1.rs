///Register `DDATA1` reader
pub type R = crate::R<DDATA1rs>;
///Register `DDATA1` writer
pub type W = crate::W<DDATA1rs>;
///Field `DDATA1` reader - Double Data 0 Access
pub type Ddata1R = crate::FieldReader<u32>;
///Field `DDATA1` writer - Double Data 0 Access
...
impl W {
    ///Bits 0:31 - Double Data 0 Access
    #[inline(always)]
    pub fn ddata1(&mut self) -> Ddata1W<'_, DDATA1rs> {
        Ddata1W::new(self, 0)
    }
}
...
///`read()` method returns [`ddata1::R`](R) reader structure
impl crate::Readable for DDATA1rs {}
///`write(|w| ..)` method takes [`ddata1::W`](W) writer structure
