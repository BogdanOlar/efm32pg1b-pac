...
///Field `DATA0ZERO` reader - Data 0 Zero
...
///Field `DDATA0LSBS` reader - LSBs in DDATA0
pub type Ddata0lsbsR = crate::FieldReader;
///Field `DDATA0MSBS` reader - MSB in DDATA0
pub type Ddata0msbsR = crate::FieldReader;
///Field `DDATA1MSB` reader - MSB in DDATA1
pub type Ddata1msbR = crate::BitReader;
///Field `CARRY` reader - Carry From Arithmetic Operation
