///Register `DDATA1BYTE` reader
pub type R = crate::R<DDATA1BYTErs>;
///Register `DDATA1BYTE` writer
pub type W = crate::W<DDATA1BYTErs>;
///Field `DDATA1BYTE` reader - Ddata 1 Byte Access
pub type Ddata1byteR = crate::FieldReader;
///Field `DDATA1BYTE` writer - Ddata 1 Byte Access
...
impl W {
    ///Bits 0:7 - Ddata 1 Byte Access
    #[inline(always)]
    pub fn ddata1byte(&mut self) -> Ddata1byteW<'_, DDATA1BYTErs> {
...
///`read()` method returns [`ddata1byte::R`](R) reader structure
impl crate::Readable for DDATA1BYTErs {}
///`write(|w| ..)` method takes [`ddata1byte::W`](W) writer structure
