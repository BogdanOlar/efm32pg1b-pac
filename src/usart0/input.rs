...
pub type CLKPRSSEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O, CLKPRSSEL_A>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INPUT")
            ...
            .field("clkprssel", &format_args!("{}", self.clkprssel().bits()))
            .field("clkprs", &format_args!("{}", self.clkprs().bit()))
            .finish()
    }
}
