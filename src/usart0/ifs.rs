...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn txuf(&mut self) -> TXUF_W<IFSrs> {
        TXUF_W::new(self, 7)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn ssm(&mut self) -> SSM_W<IFSrs> {
        SSM_W::new(self, 11)
    }
    #[doc = "Bit 12 - Set CCF Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn ccf(&mut self) -> CCF_W<IFSrs> {
        CCF_W::new(self, 12)
    }
    #[doc = "Bit 13 - Set TXIDLE Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn txidle(&mut self) -> TXIDLE_W<IFSrs> {
        TXIDLE_W::new(self, 13)
    }
    #[doc = "Bit 14 - Set TCMP0 Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn tcmp0(&mut self) -> TCMP0_W<IFSrs> {
        TCMP0_W::new(self, 14)
    }
    #[doc = "Bit 15 - Set TCMP1 Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn tcmp1(&mut self) -> TCMP1_W<IFSrs> {
        TCMP1_W::new(self, 15)
    }
    #[doc = "Bit 16 - Set TCMP2 Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn tcmp2(&mut self) -> TCMP2_W<IFSrs> {
        TCMP2_W::new(self, 16)
    }
