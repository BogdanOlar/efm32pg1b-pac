...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CTRL")
            .field("sync", &format_args!("{}", self.sync().bit()))
            .field("loopbk", &format_args!("{}", self.loopbk().bit()))
            .field("ccen", &format_args!("{}", self.ccen().bit()))
            .field("mpm", &format_args!("{}", self.mpm().bit()))
            .field("mpab", &format_args!("{}", self.mpab().bit()))
            .field("ovs", &format_args!("{}", self.ovs().bits()))
            .field("clkpol", &format_args!("{}", self.clkpol().bit()))
            .field("clkpha", &format_args!("{}", self.clkpha().bit()))
            .field("msbf", &format_args!("{}", self.msbf().bit()))
            .field("csma", &format_args!("{}", self.csma().bit()))
            .field("txbil", &format_args!("{}", self.txbil().bit()))
            .field("rxinv", &format_args!("{}", self.rxinv().bit()))
            .field("txinv", &format_args!("{}", self.txinv().bit()))
            .field("csinv", &format_args!("{}", self.csinv().bit()))
            .field("autocs", &format_args!("{}", self.autocs().bit()))
            .field("autotri", &format_args!("{}", self.autotri().bit()))
            .field("scmode", &format_args!("{}", self.scmode().bit()))
            .field("scretrans", &format_args!("{}", self.scretrans().bit()))
            .field("skipperrf", &format_args!("{}", self.skipperrf().bit()))
            .field("bit8dv", &format_args!("{}", self.bit8dv().bit()))
            .field("errsdma", &format_args!("{}", self.errsdma().bit()))
            .field("errsrx", &format_args!("{}", self.errsrx().bit()))
            .field("errstx", &format_args!("{}", self.errstx().bit()))
            .field("sssearly", &format_args!("{}", self.sssearly().bit()))
            .field("byteswap", &format_args!("{}", self.byteswap().bit()))
            .field("autotx", &format_args!("{}", self.autotx().bit()))
            .field("mvdis", &format_args!("{}", self.mvdis().bit()))
            .field("smsdelay", &format_args!("{}", self.smsdelay().bit()))
            .finish()
    }
}
