...
impl W {
    ///Bits 0:7 - Timer Comparator 0
    #[inline(always)]
    pub fn tcmpval(&mut self) -> TcmpvalW<'_, TIMECMP0rs> {
        TcmpvalW::new(self, 0)
    }
    ///Bits 16:18 - Timer Start Source
    #[inline(always)]
    pub fn tstart(&mut self) -> TstartW<'_, TIMECMP0rs> {
        TstartW::new(self, 16)
    }
    ///Bits 20:22 - Source Used to Disable Comparator 0
    #[inline(always)]
    pub fn tstop(&mut self) -> TstopW<'_, TIMECMP0rs> {
        TstopW::new(self, 20)
    }
    ///Bit 24 - Restart Timer on TCMP0
    #[inline(always)]
    pub fn restarten(&mut self) -> RestartenW<'_, TIMECMP0rs> {
