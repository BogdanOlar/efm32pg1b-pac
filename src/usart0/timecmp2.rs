...
pub type TCMPVAL_W<'a, const O: u8> = crate::FieldWriter<'a, TIMECMP2_SPEC, 8, O>;
...
pub type TSTART_W<'a, const O: u8> = crate::FieldWriter<'a, TIMECMP2_SPEC, 3, O, TSTART_A>;
...
pub type TSTOP_W<'a, const O: u8> = crate::FieldWriter<'a, TIMECMP2_SPEC, 3, O, TSTOP_A>;
...
pub type RESTARTEN_W<'a, const O: u8> = crate::BitWriter<'a, TIMECMP2_SPEC, O>;
impl R {
