...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CTRL")
            ...
            .field("polysel", &format_args!("{}", self.polysel().bit()))
            .field("bytemode", &format_args!("{}", self.bytemode().bit()))
            .field("bitreverse", &format_args!("{}", self.bitreverse().bit()))
            .field("bytereverse", &format_args!("{}", self.bytereverse().bit()))
            .field("autoinit", &format_args!("{}", self.autoinit().bit()))
            .finish()
    }
}
