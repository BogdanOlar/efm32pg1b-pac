...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dirchg(&mut self) -> DIRCHG_W<IFCrs> {
        DIRCHG_W::new(self, 2)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc3(&mut self) -> CC3_W<IFCrs> {
        CC3_W::new(self, 7)
    }
    #[doc = "Bit 8 - Clear ICBOF0 Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn icbof0(&mut self) -> ICBOF0_W<IFCrs> {
        ICBOF0_W::new(self, 8)
    }
    #[doc = "Bit 9 - Clear ICBOF1 Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn icbof1(&mut self) -> ICBOF1_W<IFCrs> {
        ICBOF1_W::new(self, 9)
    }
    #[doc = "Bit 10 - Clear ICBOF2 Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn icbof2(&mut self) -> ICBOF2_W<IFCrs> {
        ICBOF2_W::new(self, 10)
    }
    #[doc = "Bit 11 - Clear ICBOF3 Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn icbof3(&mut self) -> ICBOF3_W<IFCrs> {
