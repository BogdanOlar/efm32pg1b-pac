...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DTOGEN")
            .field("dtogcc0en", &format_args!("{}", self.dtogcc0en().bit()))
            .field("dtogcc1en", &format_args!("{}", self.dtogcc1en().bit()))
            .field("dtogcc2en", &format_args!("{}", self.dtogcc2en().bit()))
            .field("dtogcdti0en", &format_args!("{}", self.dtogcdti0en().bit()))
            .field("dtogcdti1en", &format_args!("{}", self.dtogcdti1en().bit()))
            .field("dtogcdti2en", &format_args!("{}", self.dtogcdti2en().bit()))
            .finish()
    }
}
impl core::fmt::Debug for crate::generic::Reg<DTOGEN_SPEC> {
