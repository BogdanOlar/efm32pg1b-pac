...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ROUTELOC0")
            .field("cc0loc", &format_args!("{}", self.cc0loc().bits()))
            .field("cc1loc", &format_args!("{}", self.cc1loc().bits()))
            .field("cc2loc", &format_args!("{}", self.cc2loc().bits()))
            .field("cc3loc", &format_args!("{}", self.cc3loc().bits()))
            .finish()
    }
}
