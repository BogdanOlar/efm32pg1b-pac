...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn uf(&mut self) -> UF_W<IFSrs> {
        UF_W::new(self, 1)
    }
    #[doc = "Bit 2 - Set DIRCHG Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn dirchg(&mut self) -> DIRCHG_W<IFSrs> {
        DIRCHG_W::new(self, 2)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc3(&mut self) -> CC3_W<IFSrs> {
        CC3_W::new(self, 7)
    }
    #[doc = "Bit 8 - Set ICBOF0 Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn icbof0(&mut self) -> ICBOF0_W<IFSrs> {
        ICBOF0_W::new(self, 8)
    }
    #[doc = "Bit 9 - Set ICBOF1 Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn icbof1(&mut self) -> ICBOF1_W<IFSrs> {
        ICBOF1_W::new(self, 9)
    }
    #[doc = "Bit 10 - Set ICBOF2 Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn icbof2(&mut self) -> ICBOF2_W<IFSrs> {
        ICBOF2_W::new(self, 10)
    }
    #[doc = "Bit 11 - Set ICBOF3 Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn icbof3(&mut self) -> ICBOF3_W<IFSrs> {
