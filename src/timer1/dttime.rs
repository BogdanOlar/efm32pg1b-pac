...
pub type DTPRESC_R = crate::FieldReader<DTPRESC>;
...
pub type DTPRESC_W<'a, REG> = crate::FieldWriter<'a, REG, 4, DTPRESC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dtpresc(&mut self) -> DTPRESC_W<DTTIMErs> {
        DTPRESC_W::new(self, 0)
    }
    #[doc = "Bits 8:13 - DTI Rise-time"]
    #[inline(always)]
    #[must_use]
    pub fn dtriset(&mut self) -> DTRISET_W<DTTIMErs> {
        DTRISET_W::new(self, 8)
    }
    #[doc = "Bits 16:21 - DTI Fall-time"]
    #[inline(always)]
    #[must_use]
    pub fn dtfallt(&mut self) -> DTFALLT_W<DTTIMErs> {
