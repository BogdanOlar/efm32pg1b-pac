...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn outinv(&mut self) -> OutinvW<CC2_CTRLrs> {
        OutinvW::new(self, 2)
    }
    #[doc = "Bit 4 - Compare Output Initial State"]
    #[inline(always)]
    #[must_use]
    pub fn coist(&mut self) -> CoistW<CC2_CTRLrs> {
        CoistW::new(self, 4)
    }
    #[doc = "Bits 8:9 - Compare Match Output Action"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn cofoa(&mut self) -> CofoaW<CC2_CTRLrs> {
        CofoaW::new(self, 10)
    }
    #[doc = "Bits 12:13 - Counter Underflow Output Action"]
    #[inline(always)]
    #[must_use]
    pub fn cufoa(&mut self) -> CufoaW<CC2_CTRLrs> {
        CufoaW::new(self, 12)
    }
    #[doc = "Bits 16:19 - Compare/Capture Channel PRS Input Channel Selection"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn icevctrl(&mut self) -> IcevctrlW<CC2_CTRLrs> {
        IcevctrlW::new(self, 26)
    }
    #[doc = "Bit 28 - PRS Configuration"]
    #[inline(always)]
    #[must_use]
    pub fn prsconf(&mut self) -> PrsconfW<CC2_CTRLrs> {
        PrsconfW::new(self, 28)
    }
    #[doc = "Bit 29 - Input Selection"]
    #[inline(always)]
    #[must_use]
    pub fn insel(&mut self) -> InselW<CC2_CTRLrs> {
        InselW::new(self, 29)
    }
    #[doc = "Bit 30 - Digital Filter"]
    #[inline(always)]
    #[must_use]
    pub fn filt(&mut self) -> FiltW<CC2_CTRLrs> {
        FiltW::new(self, 30)
    }
}
