...
pub type HYST_W<'a, const O: u8> = crate::FieldWriterSafe<'a, HYSTERESIS0_SPEC, 4, O, HYST_A>;
...
pub type DIVVA_W<'a, const O: u8> = crate::FieldWriter<'a, HYSTERESIS0_SPEC, 6, O>;
...
pub type DIVVB_W<'a, const O: u8> = crate::FieldWriter<'a, HYSTERESIS0_SPEC, 6, O>;
impl R {
