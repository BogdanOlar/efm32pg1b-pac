...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CTRL")
            ...
            .field("inactval", &format_args!("{}", self.inactval().bit()))
            .field("gpioinv", &format_args!("{}", self.gpioinv().bit()))
            .field(
                "aportxmasterdis",
                &format_args!("{}", self.aportxmasterdis().bit()),
            )
            .field(
                "aportymasterdis",
                &format_args!("{}", self.aportymasterdis().bit()),
            )
            .field(
                "aportvmasterdis",
                &format_args!("{}", self.aportvmasterdis().bit()),
            )
            .field("pwrsel", &format_args!("{}", self.pwrsel().bits()))
            .field("accuracy", &format_args!("{}", self.accuracy().bit()))
            .field("inputrange", &format_args!("{}", self.inputrange().bits()))
            .field("irise", &format_args!("{}", self.irise().bit()))
            .field("ifall", &format_args!("{}", self.ifall().bit()))
            .field("biasprog", &format_args!("{}", self.biasprog().bits()))
            .field("fullbias", &format_args!("{}", self.fullbias().bit()))
            .finish()
    }
}
