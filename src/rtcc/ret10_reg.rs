///Register `RET10_REG` reader
pub type R = crate::R<RET10_REGrs>;
///Register `RET10_REG` writer
pub type W = crate::W<RET10_REGrs>;
...
impl W {
    ///Bits 0:31 - General Purpose Retention Register
    #[inline(always)]
    pub fn reg(&mut self) -> RegW<'_, RET10_REGrs> {
        RegW::new(self, 0)
    }
}
///Retention Register
...
pub struct RET10_REGrs;
impl crate::RegisterSpec for RET10_REGrs {
    type Ux = u32;
}
///`read()` method returns [`ret10_reg::R`](R) reader structure
impl crate::Readable for RET10_REGrs {}
///`write(|w| ..)` method takes [`ret10_reg::W`](W) writer structure
impl crate::Writable for RET10_REGrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets RET10_REG to value 0
impl crate::Resettable for RET10_REGrs {}
