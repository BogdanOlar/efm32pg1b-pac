...
impl W {
    ///Bits 0:3 - Day of Month/week, Units
    #[inline(always)]
    pub fn dayu(&mut self) -> DayuW<'_, CC1_DATErs> {
        DayuW::new(self, 0)
    }
    ///Bits 4:5 - Day of Month/week, Tens
    #[inline(always)]
    pub fn dayt(&mut self) -> DaytW<'_, CC1_DATErs> {
        DaytW::new(self, 4)
    }
    ///Bits 8:11 - Month, Units
    #[inline(always)]
    pub fn monthu(&mut self) -> MonthuW<'_, CC1_DATErs> {
        MonthuW::new(self, 8)
    }
    ///Bit 12 - Month, Tens
    #[inline(always)]
    pub fn montht(&mut self) -> MonthtW<'_, CC1_DATErs> {
        MonthtW::new(self, 12)
    }
}
