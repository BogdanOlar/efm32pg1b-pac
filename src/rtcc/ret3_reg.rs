///Register `RET3_REG` reader
pub type R = crate::R<RET3_REGrs>;
///Register `RET3_REG` writer
...
impl W {
    ///Bits 0:31 - General Purpose Retention Register
    #[inline(always)]
    pub fn reg(&mut self) -> RegW<'_, RET3_REGrs> {
        RegW::new(self, 0)
    }
}
///Retention Register
...
///`read()` method returns [`ret3_reg::R`](R) reader structure
impl crate::Readable for RET3_REGrs {}
///`write(|w| ..)` method takes [`ret3_reg::W`](W) writer structure
