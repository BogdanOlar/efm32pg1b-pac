///Register `RET17_REG` reader
pub type R = crate::R<RET17_REGrs>;
///Register `RET17_REG` writer
...
impl W {
    ///Bits 0:31 - General Purpose Retention Register
    #[inline(always)]
    pub fn reg(&mut self) -> RegW<'_, RET17_REGrs> {
        RegW::new(self, 0)
    }
}
///Retention Register
...
///`read()` method returns [`ret17_reg::R`](R) reader structure
impl crate::Readable for RET17_REGrs {}
///`write(|w| ..)` method takes [`ret17_reg::W`](W) writer structure
