///Register `RET19_REG` reader
pub type R = crate::R<RET19_REGrs>;
///Register `RET19_REG` writer
...
impl W {
    ///Bits 0:31 - General Purpose Retention Register
    #[inline(always)]
    pub fn reg(&mut self) -> RegW<'_, RET19_REGrs> {
        RegW::new(self, 0)
    }
}
///Retention Register
...
///`read()` method returns [`ret19_reg::R`](R) reader structure
impl crate::Readable for RET19_REGrs {}
///`write(|w| ..)` method takes [`ret19_reg::W`](W) writer structure
