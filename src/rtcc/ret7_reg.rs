///Register `RET7_REG` reader
pub type R = crate::R<RET7_REGrs>;
///Register `RET7_REG` writer
pub type W = crate::W<RET7_REGrs>;
...
impl W {
    ///Bits 0:31 - General Purpose Retention Register
    #[inline(always)]
    pub fn reg(&mut self) -> RegW<'_, RET7_REGrs> {
        RegW::new(self, 0)
    }
}
///Retention Register
...
pub struct RET7_REGrs;
impl crate::RegisterSpec for RET7_REGrs {
    type Ux = u32;
}
///`read()` method returns [`ret7_reg::R`](R) reader structure
impl crate::Readable for RET7_REGrs {}
///`write(|w| ..)` method takes [`ret7_reg::W`](W) writer structure
impl crate::Writable for RET7_REGrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets RET7_REG to value 0
impl crate::Resettable for RET7_REGrs {}
