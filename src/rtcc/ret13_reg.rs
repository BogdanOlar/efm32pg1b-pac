///Register `RET13_REG` reader
pub type R = crate::R<RET13_REGrs>;
///Register `RET13_REG` writer
pub type W = crate::W<RET13_REGrs>;
...
impl W {
    ///Bits 0:31 - General Purpose Retention Register
    #[inline(always)]
    pub fn reg(&mut self) -> RegW<'_, RET13_REGrs> {
        RegW::new(self, 0)
    }
}
///Retention Register
...
pub struct RET13_REGrs;
impl crate::RegisterSpec for RET13_REGrs {
    type Ux = u32;
}
///`read()` method returns [`ret13_reg::R`](R) reader structure
impl crate::Readable for RET13_REGrs {}
///`write(|w| ..)` method takes [`ret13_reg::W`](W) writer structure
impl crate::Writable for RET13_REGrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets RET13_REG to value 0
impl crate::Resettable for RET13_REGrs {}
