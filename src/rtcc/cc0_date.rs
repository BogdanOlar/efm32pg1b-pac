///Register `CC0_DATE` reader
pub type R = crate::R<CC0_DATErs>;
///Register `CC0_DATE` writer
...
impl W {
    ///Bits 0:3 - Day of Month/week, Units
    #[inline(always)]
    pub fn dayu(&mut self) -> DayuW<'_, CC0_DATErs> {
        DayuW::new(self, 0)
    }
    ///Bits 4:5 - Day of Month/week, Tens
    #[inline(always)]
    pub fn dayt(&mut self) -> DaytW<'_, CC0_DATErs> {
        DaytW::new(self, 4)
    }
    ///Bits 8:11 - Month, Units
    #[inline(always)]
    pub fn monthu(&mut self) -> MonthuW<'_, CC0_DATErs> {
        MonthuW::new(self, 8)
    }
    ///Bit 12 - Month, Tens
    #[inline(always)]
    pub fn montht(&mut self) -> MonthtW<'_, CC0_DATErs> {
        MonthtW::new(self, 12)
    }
}
...
///`read()` method returns [`cc0_date::R`](R) reader structure
impl crate::Readable for CC0_DATErs {}
///`write(|w| ..)` method takes [`cc0_date::W`](W) writer structure
