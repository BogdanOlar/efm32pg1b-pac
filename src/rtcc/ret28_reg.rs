///Register `RET28_REG` reader
pub type R = crate::R<RET28_REGrs>;
///Register `RET28_REG` writer
pub type W = crate::W<RET28_REGrs>;
...
impl W {
    ///Bits 0:31 - General Purpose Retention Register
    #[inline(always)]
    pub fn reg(&mut self) -> RegW<'_, RET28_REGrs> {
        RegW::new(self, 0)
    }
}
///Retention Register
...
pub struct RET28_REGrs;
impl crate::RegisterSpec for RET28_REGrs {
    type Ux = u32;
}
///`read()` method returns [`ret28_reg::R`](R) reader structure
impl crate::Readable for RET28_REGrs {}
///`write(|w| ..)` method takes [`ret28_reg::W`](W) writer structure
impl crate::Writable for RET28_REGrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets RET28_REG to value 0
impl crate::Resettable for RET28_REGrs {}
