///Register `RET6_REG` reader
pub type R = crate::R<RET6_REGrs>;
///Register `RET6_REG` writer
...
impl W {
    ///Bits 0:31 - General Purpose Retention Register
    #[inline(always)]
    pub fn reg(&mut self) -> RegW<'_, RET6_REGrs> {
        RegW::new(self, 0)
    }
}
///Retention Register
...
///`read()` method returns [`ret6_reg::R`](R) reader structure
impl crate::Readable for RET6_REGrs {}
///`write(|w| ..)` method takes [`ret6_reg::W`](W) writer structure
