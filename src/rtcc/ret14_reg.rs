///Register `RET14_REG` reader
pub type R = crate::R<RET14_REGrs>;
///Register `RET14_REG` writer
...
impl W {
    ///Bits 0:31 - General Purpose Retention Register
    #[inline(always)]
    pub fn reg(&mut self) -> RegW<'_, RET14_REGrs> {
        RegW::new(self, 0)
    }
}
///Retention Register
...
///`read()` method returns [`ret14_reg::R`](R) reader structure
impl crate::Readable for RET14_REGrs {}
///`write(|w| ..)` method takes [`ret14_reg::W`](W) writer structure
