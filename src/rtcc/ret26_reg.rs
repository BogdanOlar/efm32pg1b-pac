///Register `RET26_REG` reader
pub type R = crate::R<RET26_REGrs>;
///Register `RET26_REG` writer
pub type W = crate::W<RET26_REGrs>;
...
impl W {
    ///Bits 0:31 - General Purpose Retention Register
    #[inline(always)]
    pub fn reg(&mut self) -> RegW<'_, RET26_REGrs> {
        RegW::new(self, 0)
    }
}
///Retention Register
...
pub struct RET26_REGrs;
impl crate::RegisterSpec for RET26_REGrs {
    type Ux = u32;
}
///`read()` method returns [`ret26_reg::R`](R) reader structure
impl crate::Readable for RET26_REGrs {}
///`write(|w| ..)` method takes [`ret26_reg::W`](W) writer structure
impl crate::Writable for RET26_REGrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets RET26_REG to value 0
impl crate::Resettable for RET26_REGrs {}
