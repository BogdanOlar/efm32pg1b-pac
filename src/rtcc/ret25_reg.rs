///Register `RET25_REG` reader
pub type R = crate::R<RET25_REGrs>;
///Register `RET25_REG` writer
...
impl W {
    ///Bits 0:31 - General Purpose Retention Register
    #[inline(always)]
    pub fn reg(&mut self) -> RegW<'_, RET25_REGrs> {
        RegW::new(self, 0)
    }
}
///Retention Register
...
///`read()` method returns [`ret25_reg::R`](R) reader structure
impl crate::Readable for RET25_REGrs {}
///`write(|w| ..)` method takes [`ret25_reg::W`](W) writer structure
