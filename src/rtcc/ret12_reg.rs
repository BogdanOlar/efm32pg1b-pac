///Register `RET12_REG` reader
pub type R = crate::R<RET12_REGrs>;
///Register `RET12_REG` writer
pub type W = crate::W<RET12_REGrs>;
...
impl W {
    ///Bits 0:31 - General Purpose Retention Register
    #[inline(always)]
    pub fn reg(&mut self) -> RegW<'_, RET12_REGrs> {
        RegW::new(self, 0)
    }
}
///Retention Register
...
pub struct RET12_REGrs;
impl crate::RegisterSpec for RET12_REGrs {
    type Ux = u32;
}
///`read()` method returns [`ret12_reg::R`](R) reader structure
impl crate::Readable for RET12_REGrs {}
///`write(|w| ..)` method takes [`ret12_reg::W`](W) writer structure
impl crate::Writable for RET12_REGrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets RET12_REG to value 0
impl crate::Resettable for RET12_REGrs {}
