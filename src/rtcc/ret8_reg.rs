///Register `RET8_REG` reader
pub type R = crate::R<RET8_REGrs>;
///Register `RET8_REG` writer
...
impl W {
    ///Bits 0:31 - General Purpose Retention Register
    #[inline(always)]
    pub fn reg(&mut self) -> RegW<'_, RET8_REGrs> {
        RegW::new(self, 0)
    }
}
///Retention Register
...
///`read()` method returns [`ret8_reg::R`](R) reader structure
impl crate::Readable for RET8_REGrs {}
///`write(|w| ..)` method takes [`ret8_reg::W`](W) writer structure
