///Register `RET18_REG` reader
pub type R = crate::R<RET18_REGrs>;
///Register `RET18_REG` writer
...
impl W {
    ///Bits 0:31 - General Purpose Retention Register
    #[inline(always)]
    pub fn reg(&mut self) -> RegW<'_, RET18_REGrs> {
        RegW::new(self, 0)
    }
}
///Retention Register
...
///`read()` method returns [`ret18_reg::R`](R) reader structure
impl crate::Readable for RET18_REGrs {}
///`write(|w| ..)` method takes [`ret18_reg::W`](W) writer structure
