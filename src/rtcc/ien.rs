...
pub type OSCFAIL_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type CNTTICK_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type MINTICK_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type HOURTICK_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type DAYTICK_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type DAYOWOF_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type MONTHTICK_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
impl R {
