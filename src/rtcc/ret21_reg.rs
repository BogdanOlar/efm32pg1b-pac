///Register `RET21_REG` reader
pub type R = crate::R<RET21_REGrs>;
///Register `RET21_REG` writer
...
impl W {
    ///Bits 0:31 - General Purpose Retention Register
    #[inline(always)]
    pub fn reg(&mut self) -> RegW<'_, RET21_REGrs> {
        RegW::new(self, 0)
    }
}
///Retention Register
...
///`read()` method returns [`ret21_reg::R`](R) reader structure
impl crate::Readable for RET21_REGrs {}
///`write(|w| ..)` method takes [`ret21_reg::W`](W) writer structure
