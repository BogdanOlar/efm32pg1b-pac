...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aport1xmasterdis(&mut self) -> APORT1XMASTERDIS_W<APORTMASTERDISrs> {
        APORT1XMASTERDIS_W::new(self, 2)
    }
    #[doc = "Bit 3 - APORT1Y Master Disable"]
    #[inline(always)]
    #[must_use]
    pub fn aport1ymasterdis(&mut self) -> APORT1YMASTERDIS_W<APORTMASTERDISrs> {
        APORT1YMASTERDIS_W::new(self, 3)
    }
    #[doc = "Bit 4 - APORT2X Master Disable"]
    #[inline(always)]
    #[must_use]
    pub fn aport2xmasterdis(&mut self) -> APORT2XMASTERDIS_W<APORTMASTERDISrs> {
        APORT2XMASTERDIS_W::new(self, 4)
    }
    #[doc = "Bit 5 - APORT2Y Master Disable"]
    #[inline(always)]
    #[must_use]
    pub fn aport2ymasterdis(&mut self) -> APORT2YMASTERDIS_W<APORTMASTERDISrs> {
        APORT2YMASTERDIS_W::new(self, 5)
    }
    #[doc = "Bit 6 - APORT3X Master Disable"]
    #[inline(always)]
    #[must_use]
    pub fn aport3xmasterdis(&mut self) -> APORT3XMASTERDIS_W<APORTMASTERDISrs> {
        APORT3XMASTERDIS_W::new(self, 6)
    }
    #[doc = "Bit 7 - APORT3Y Master Disable"]
    #[inline(always)]
    #[must_use]
    pub fn aport3ymasterdis(&mut self) -> APORT3YMASTERDIS_W<APORTMASTERDISrs> {
        APORT3YMASTERDIS_W::new(self, 7)
    }
    #[doc = "Bit 8 - APORT4X Master Disable"]
    #[inline(always)]
    #[must_use]
    pub fn aport4xmasterdis(&mut self) -> APORT4XMASTERDIS_W<APORTMASTERDISrs> {
        APORT4XMASTERDIS_W::new(self, 8)
    }
    #[doc = "Bit 9 - APORT4Y Master Disable"]
    #[inline(always)]
    #[must_use]
    pub fn aport4ymasterdis(&mut self) -> APORT4YMASTERDIS_W<APORTMASTERDISrs> {
