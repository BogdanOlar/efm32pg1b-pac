///Register `BIASPROG` reader
pub type R = crate::R<BIASPROGrs>;
///Register `BIASPROG` writer
...
///Field `VFAULTCLR` reader - Clear VREFOF Flag
pub type VfaultclrR = crate::BitReader;
///Field `VFAULTCLR` writer - Clear VREFOF Flag
pub type VfaultclrW<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GPBIASACC` reader - Accuracy Setting for the System Bias During ADC Operation
pub type GpbiasaccR = crate::BitReader;
///Field `GPBIASACC` writer - Accuracy Setting for the System Bias During ADC Operation
...
///`read()` method returns [`biasprog::R`](R) reader structure
