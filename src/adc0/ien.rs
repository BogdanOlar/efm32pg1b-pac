...
pub type SINGLEOF_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type SCANOF_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type SINGLEUF_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type SCANUF_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type SINGLECMP_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type SCANCMP_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type VREFOV_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
...
pub type PROGERR_W<'a, const O: u8> = crate::BitWriter<'a, IEN_SPEC, O>;
impl R {
