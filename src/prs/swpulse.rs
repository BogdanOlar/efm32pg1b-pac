///Register `SWPULSE` writer
pub type W = crate::W<SWPULSErs>;
///Field `CH0PULSE` writer - Channel 0 Pulse Generation
pub type Ch0pulseW<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH1PULSE` writer - Channel 1 Pulse Generation
pub type Ch1pulseW<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH2PULSE` writer - Channel 2 Pulse Generation
pub type Ch2pulseW<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH3PULSE` writer - Channel 3 Pulse Generation
pub type Ch3pulseW<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH4PULSE` writer - Channel 4 Pulse Generation
pub type Ch4pulseW<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH5PULSE` writer - Channel 5 Pulse Generation
pub type Ch5pulseW<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH6PULSE` writer - Channel 6 Pulse Generation
pub type Ch6pulseW<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH7PULSE` writer - Channel 7 Pulse Generation
pub type Ch7pulseW<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH8PULSE` writer - Channel 8 Pulse Generation
pub type Ch8pulseW<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH9PULSE` writer - Channel 9 Pulse Generation
pub type Ch9pulseW<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH10PULSE` writer - Channel 10 Pulse Generation
pub type Ch10pulseW<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH11PULSE` writer - Channel 11 Pulse Generation
