...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ROUTELOC1")
            .field("ch4loc", &format_args!("{}", self.ch4loc().bits()))
            .field("ch5loc", &format_args!("{}", self.ch5loc().bits()))
            .field("ch6loc", &format_args!("{}", self.ch6loc().bits()))
            .field("ch7loc", &format_args!("{}", self.ch7loc().bits()))
            .finish()
    }
}
