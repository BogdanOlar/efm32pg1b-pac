...
///Field `CH4LOC` reader - I/O Location
...
///Field `CH4LOC` writer - I/O Location
...
///Field `CH5LOC` reader - I/O Location
...
///Field `CH5LOC` writer - I/O Location
...
///Field `CH6LOC` reader - I/O Location
...
///Field `CH6LOC` writer - I/O Location
...
///Field `CH7LOC` reader - I/O Location
...
///Field `CH7LOC` writer - I/O Location
...
impl W {
    ///Bits 0:5 - I/O Location
    #[inline(always)]
    pub fn ch4loc(&mut self) -> Ch4locW<'_, ROUTELOC1rs> {
        Ch4locW::new(self, 0)
    }
    ///Bits 8:13 - I/O Location
    #[inline(always)]
    pub fn ch5loc(&mut self) -> Ch5locW<'_, ROUTELOC1rs> {
        Ch5locW::new(self, 8)
    }
    ///Bits 16:21 - I/O Location
    #[inline(always)]
    pub fn ch6loc(&mut self) -> Ch6locW<'_, ROUTELOC1rs> {
        Ch6locW::new(self, 16)
    }
    ///Bits 24:29 - I/O Location
    #[inline(always)]
    pub fn ch7loc(&mut self) -> Ch7locW<'_, ROUTELOC1rs> {
        Ch7locW::new(self, 24)
    }
}
