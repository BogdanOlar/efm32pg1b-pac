...
pub type SOURCESEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CH9_CTRL_SPEC, u8, SOURCESEL_A, 7, O>;
...
pub type ASYNCREFL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH9_CTRL_SPEC, bool, O>;
impl R {
