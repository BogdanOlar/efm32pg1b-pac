///Register `CH9_CTRL` reader
pub type R = crate::R<CH9_CTRLrs>;
///Register `CH9_CTRL` writer
pub type W = crate::W<CH9_CTRLrs>;
...
impl W {
    ///Bits 0:2 - Signal Select
    #[inline(always)]
    pub fn sigsel(&mut self) -> SigselW<'_, CH9_CTRLrs> {
        SigselW::new(self, 0)
    }
    ///Bits 8:14 - Source Select
    #[inline(always)]
    pub fn sourcesel(&mut self) -> SourceselW<'_, CH9_CTRLrs> {
        SourceselW::new(self, 8)
    }
    ///Bits 20:21 - Edge Detect Select
    #[inline(always)]
    pub fn edsel(&mut self) -> EdselW<'_, CH9_CTRLrs> {
        EdselW::new(self, 20)
    }
    ///Bit 25 - Stretch Channel Output
    #[inline(always)]
    pub fn stretch(&mut self) -> StretchW<'_, CH9_CTRLrs> {
        StretchW::new(self, 25)
    }
    ///Bit 26 - Invert Channel
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, CH9_CTRLrs> {
        InvW::new(self, 26)
    }
    ///Bit 27 - Or Previous
    #[inline(always)]
    pub fn orprev(&mut self) -> OrprevW<'_, CH9_CTRLrs> {
        OrprevW::new(self, 27)
    }
    ///Bit 28 - And Next
    #[inline(always)]
    pub fn andnext(&mut self) -> AndnextW<'_, CH9_CTRLrs> {
        AndnextW::new(self, 28)
    }
    ///Bit 30 - Asynchronous Reflex
    #[inline(always)]
    pub fn asyncrefl(&mut self) -> AsyncreflW<'_, CH9_CTRLrs> {
...
pub struct CH9_CTRLrs;
impl crate::RegisterSpec for CH9_CTRLrs {
    type Ux = u32;
}
///`read()` method returns [`ch9_ctrl::R`](R) reader structure
impl crate::Readable for CH9_CTRLrs {}
///`write(|w| ..)` method takes [`ch9_ctrl::W`](W) writer structure
impl crate::Writable for CH9_CTRLrs {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CH9_CTRL to value 0
impl crate::Resettable for CH9_CTRLrs {}
