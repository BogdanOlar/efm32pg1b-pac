...
impl W {
    ///Bits 0:2 - Signal Select
    #[inline(always)]
    pub fn sigsel(&mut self) -> SigselW<'_, CH5_CTRLrs> {
        SigselW::new(self, 0)
    }
    ///Bits 8:14 - Source Select
    #[inline(always)]
    pub fn sourcesel(&mut self) -> SourceselW<'_, CH5_CTRLrs> {
        SourceselW::new(self, 8)
    }
    ///Bits 20:21 - Edge Detect Select
    #[inline(always)]
    pub fn edsel(&mut self) -> EdselW<'_, CH5_CTRLrs> {
        EdselW::new(self, 20)
    }
    ///Bit 25 - Stretch Channel Output
    #[inline(always)]
    pub fn stretch(&mut self) -> StretchW<'_, CH5_CTRLrs> {
        StretchW::new(self, 25)
    }
    ///Bit 26 - Invert Channel
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, CH5_CTRLrs> {
        InvW::new(self, 26)
    }
    ///Bit 27 - Or Previous
    #[inline(always)]
    pub fn orprev(&mut self) -> OrprevW<'_, CH5_CTRLrs> {
        OrprevW::new(self, 27)
    }
    ///Bit 28 - And Next
    #[inline(always)]
    pub fn andnext(&mut self) -> AndnextW<'_, CH5_CTRLrs> {
        AndnextW::new(self, 28)
    }
    ///Bit 30 - Asynchronous Reflex
    #[inline(always)]
    pub fn asyncrefl(&mut self) -> AsyncreflW<'_, CH5_CTRLrs> {
